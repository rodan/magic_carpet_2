...
#define _chdir chdir
#endif
//#include <stdlib.h>//#include <string.h>//#include <ctype.h>// //#define DEBUG_PRINT_DEBUG_TO_SCREEN
...
std::string GetSubDirectoryFile(const char *gamepath, const char *subDirectory,
                                const char *fileName);
