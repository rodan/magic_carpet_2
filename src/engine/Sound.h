...
void sub_8F100_sound_proc19(uint32_t a1, __int16 index, int volume, int a4, unsigned __int16 a5,
                            char a6, unsigned __int8 a7);
void sub_8F420_sound_proc20(int a1, __int16 a2);
void sub_8F710_sound_proc21(int flags, __int16 index, int loopCount, unsigned __int8 initTimers,
                            char volScale);
...
void AilSendChannelVoiceMessage_98360(HMDIDRIVER mdi, HSEQUENCE hSequence, int32_t status,
                                      int32_t data_1, int32_t data_2);
...
void AilAPISendChannelVoiceMessage_A9140(HMDIDRIVER mdi, HSEQUENCE hSequence, int32_t status,
                                         int32_t data_1, int32_t data_2);
int sub_A9C00();
int sub_A9C50();
