...
GameRenderHD::GameRenderHD(uint8_t *ptrScreenBuffer, uint8_t *pColorPalette, uint16_t screenWidth,
                           uint16_t screenHeight, uint8_t renderThreads,
                           bool assignToSpecificCores):m_ptrScreenBuffer_351628(ptrScreenBuffer),
m_ptrColorPalette(pColorPalette), m_uiScreenWidth_18062C(screenWidth),
m_uiScreenHeight_180624(screenHeight), m_assignToSpecificCores(assignToSpecificCores)
{
...
void GameRenderHD::DrawWorld_411A0(int posX, int posY, int16_t yaw, int16_t posZ, int16_t pitch,
                                   int16_t roll, int16_t fov)
{
    ...
    if (D41A0_0.m_GameSettings.str_0x2192.xxxx_0x2193
        && D41A0_0.m_GameSettings.m_Display.m_uiScreenSize && m_uiScreenWidth_18062C == 640) {
        //VR interlaced render
        viewPort.SetRenderViewPortSize_BCD45(m_ptrScreenBuffer_351628,
        ...
        viewPort.SetRenderViewPortSize_BCD45(m_ptrScreenBuffer_351628 +
                                             (m_uiScreenWidth_18062C / 2), 0, 0, 0);
        x_DWORD_D4324 = 5;
        DrawTerrainAndParticles_3C080(vPosX + v26, vPosY + v25, vYaw, posZ, pitch, roll, fov);
        x_DWORD_D4324 = 0;
        viewPort.SetRenderViewPortSize_BCD45(m_ptrScreenBuffer_351628, m_uiScreenWidth_18062C,
                                             m_uiScreenWidth_18062C, m_uiScreenHeight_180624);
        ...
        if (x_WORD_180660_VGA_type_resolution == 1) {
            if (!D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].byte_0x3DF_2BE4_12221) {
                if (engine_db.m_wHighSpeedSystem) {
                    if (x_DWORD_E9C3C) {
                        if (D41A0_0.m_GameSettings.m_Graphics.m_wViewPortSize == 40) {
                            v34 =
                                x_DWORD_EA3E4[D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].
                                              word_0x00a_2BE4_11240]->actSpeed_0x82_130;
        ...
        if (D41A0_0.str_0x21AE.xxxx_0x21B1 && D41A0_0.m_GameSettings.m_Display.xxxx_0x2191
            && x_DWORD_E9C3C) {
            //Blur
            ...
            LOBYTE(v36) = x_BYTE_F6EE0_tablesx[16384 + v39];
            HIBYTE(v40) = v35[1];
            for (BYTE1(v36) = x_BYTE_F6EE0_tablesx[16384 + v40];;
                 BYTE1(v36) = x_BYTE_F6EE0_tablesx[16384 + v42]) {
                *(x_DWORD *) v35 = v36;
                v35 += 4;
                v37 += 4;
                if (!--v38) {
...
void GameRenderHD::WriteWorldToBMP()
{
    ...
    BitmapIO::WriteImageBufferAsImageBMP(path.c_str(), m_uiScreenWidth_18062C,
                                         m_uiScreenHeight_180624, m_ptrColorPalette,
...
void GameRenderHD::DrawSky_40950(int16_t roll, uint8_t startLine, uint8_t drawEveryNthLine)
{
    ...
    uint8_t *viewPortRenderBufferStart =
        (ViewPortRenderBufferStart_DE558 + (startLine * iScreenWidth_DE560));
    ...
    for (int height = 0; height < viewPort.Height_DE568; height += drawEveryNthLine) {
        ...
        for (uint16_t width = 0; width < viewPort.Width_DE564; width++) {
            *viewPortLineRenderBufferStart =
                off_D41A8_sky[(texturePixelIndexX +
                               skyTextSize * texturePixelIndexY) % lineWidthSQ];
            texturePixelIndexX =
                (texturePixelIndexX + errLine[width].x + skyTextSize) % skyTextSize;
            texturePixelIndexY =
                (texturePixelIndexY + errLine[width].y + skyTextSize) % skyTextSize;
            viewPortLineRenderBufferStart++;
        }
        viewPortRenderBufferStart =
            viewPortRenderBufferStart + (iScreenWidth_DE560 * drawEveryNthLine);
...
*/
void GameRenderHD::DrawTerrainAndParticles_3C080(__int16 posX, __int16 posY, __int16 yaw, // FIXME negative posX posY
//void GameRenderHD::DrawTerrainAndParticles_3C080(uint16_t posX, uint16_t posY, uint16_t yaw,
                                                 signed int posZ, int pitch, int16_t roll, int fov)
{
    int v9;                     // eax
    int v10;                    // edx
    int v11;                    // ecx
    ...
    str_F2C20ar.dword0x24 =
        x_DWORD_D4324 + ((signed int)(unsigned __int16)viewPort.Width_DE564 >> 1);
    ...
    str_F2C20ar.dword0x18 = 7
        * Maths::sub_7277A_radix_3d((unsigned __int16)viewPort.Width_DE564 *
                                    (unsigned __int16)viewPort.Width_DE564 +
                                    (unsigned __int16)viewPort.Height_DE568 *
                                    (unsigned __int16)viewPort.Height_DE568)
        * fov >> 11;
    ...
    if (isCaveLevel_D41B6)      //21d3e3 cleaned screen
    {
        for (i = 21;; i--) {
            if (!i) {
                ...
                while (v46) {
                    v48 =
                        ((Str_E9C38_smalltit[v47x].dword16 * str_F2C20ar.dword0x11 -
                          str_F2C20ar.dword0x0d * Str_E9C38_smalltit[v47x].dword20) >> 16) +
                        str_F2C20ar.dword0x24;
                    projectedVertexBuffer[25] =
                        ((Str_E9C38_smalltit[v47x].dword16 * str_F2C20ar.dword0x11 -
                          str_F2C20ar.dword0x0d * Str_E9C38_smalltit[v47x].dword28) >> 16) +
                        str_F2C20ar.dword0x24;
                    v49 = Str_E9C38_smalltit[v47x].dword16 * str_F2C20ar.dword0x0d;
                    projectedVertexBuffer[24] =
                        str_F2C20ar.dword0x10 -
                        ((v49 + str_F2C20ar.dword0x11 * Str_E9C38_smalltit[v47x].dword20) >> 16);
                    v50 =
                        str_F2C20ar.dword0x10 -
                        ((v49 + str_F2C20ar.dword0x11 * Str_E9C38_smalltit[v47x].dword28) >> 16);
                    ...
                    if (v53 >= 0) {
                        if ((signed int)(unsigned __int16)viewPort.Width_DE564 <=
                            Str_E9C38_smalltit[v47x].dword16)
                    ...
                    if (Str_E9C38_smalltit[v47x].dword24 >= 0) {
                        if ((signed int)(unsigned __int16)viewPort.Width_DE564 <=
                            Str_E9C38_smalltit[v47x].dword24)
            ...
            for (k = 40; k; k--) {
                ...
                v35 =
                    v34 * v34 +
                    Str_E9C38_smalltit[v278x].dword0_rot * Str_E9C38_smalltit[v278x].dword0_rot;
                ...
                if (v34 < 128)
                    v34 = 128;
                Str_E9C38_smalltit[v278x].dword16 =
                    str_F2C20ar.dword0x18 * Str_E9C38_smalltit[v278x].dword0_rot / v34;
                v36 = v279;
                Str_E9C38_smalltit[v278x].dword4_height = 32 * mapHeightmap_11B4E0[v279] - posZ;
                Str_E9C38_smalltit[v278x].dword8 =
                    ((unsigned __int8)x_BYTE_14B4E0_second_heightmap[v36] << 15 >> 10) - posZ;
                v37 = 0;
                ...
                if (v35 < str_F2C20ar.dword0x16) {
                    v39 =
                        v39 * (signed __int64)(str_F2C20ar.dword0x16 - v35) / str_F2C20ar.dword0x12;
 LABEL_39:
 ...
 LABEL_40:
                ...
                //v41x = v278x;
                Str_E9C38_smalltit[v278x].dword20 =
                    str_F2C20ar.dword0x22 +
                    str_F2C20ar.dword0x18 * Str_E9C38_smalltit[v278x].dword4_height / v34;
                Str_E9C38_smalltit[v278x].dword28 =
                    str_F2C20ar.dword0x22 + v40 * Str_E9C38_smalltit[v278x].dword8 / v34;
                ...
                Str_E9C38_smalltit[v278x].byte43 =
                    Maths::x_BYTE_D41D8[Str_E9C38_smalltit[v278x].byte41];
                Str_E9C38_smalltit[v278x].byte42_std =
                    projectedVertexBuffer[32] +
                    (((signed int)(unsigned __int8)mapAngle_13B4E0[v42] >> 2) & 0x1C);
    ...
    if (D41A0_0.m_GameSettings.m_Graphics.m_wReflections) {
        for (l = 21;; l--) {
            if (!l) {
                ...
                while (v123) {
                    v125 =
                        ((str_F2C20ar.dword0x11 * Str_E9C38_smalltit[v124x].dword16 -
                          str_F2C20ar.dword0x0d * Str_E9C38_smalltit[v124x].dword20) >> 16) +
                        str_F2C20ar.dword0x24;
                    projectedVertexBuffer[25] =
                        ((str_F2C20ar.dword0x11 * Str_E9C38_smalltit[v124x].dword16 -
                          str_F2C20ar.dword0x0d * Str_E9C38_smalltit[v124x].dword28) >> 16) +
                        str_F2C20ar.dword0x24;
                    v126 = Str_E9C38_smalltit[v124x].dword16 * str_F2C20ar.dword0x0d;
                    projectedVertexBuffer[24] =
                        str_F2C20ar.dword0x10 -
                        ((v126 + str_F2C20ar.dword0x11 * Str_E9C38_smalltit[v124x].dword20) >> 16);
                    v127 =
                        str_F2C20ar.dword0x10 -
                        ((v126 + str_F2C20ar.dword0x11 * Str_E9C38_smalltit[v124x].dword28) >> 16);
                    ...
                    if (v130 >= 0) {
                        if ((signed int)(unsigned __int16)viewPort.Width_DE564 <=
                            Str_E9C38_smalltit[v124x].dword16)
                    ...
                    if (Str_E9C38_smalltit[v124x].dword24 >= 0) {
                        if ((signed int)(unsigned __int16)viewPort.Width_DE564 <=
                            Str_E9C38_smalltit[v124x].dword24)
            ...
            for (jj = 40; jj; --jj) {
                ...
                if (v109 < 128)
                    v109 = 128;
                Str_E9C38_smalltit[v278x].dword16 =
                    str_F2C20ar.dword0x18 * Str_E9C38_smalltit[v278x].dword0_rot / v109;
                v111 = v279;
                Str_E9C38_smalltit[v278x].dword4_height = 32 * mapHeightmap_11B4E0[v279] - posZ;
                v112 =
                    (unsigned __int16)D41A0_0.array_0x2BDE[D41A0_0.LevelIndex_0xc].
                    dword_0x012_2BE0_11248 << 6;
                projectedVertexBuffer[26] =
                    Maths::sin_DB750[(v112 + (HIBYTE(v279) << 7)) & 0x7FF] >> 8;
                v113 =
                    projectedVertexBuffer[26] *
                    (Maths::sin_DB750[(((unsigned __int8)v279 << 7) + v112) & 0x7FF] >> 8);
                projectedVertexBuffer[26] = mapHeightmap_11B4E0[v111];
                Str_E9C38_smalltit[v278x].dword8 =
                    -(projectedVertexBuffer[26] * ((v113 >> 4) + 0x8000) >> 10) - posZ;
                if (!(mapAngle_13B4E0[v111] & 8)
                    || (Str_E9C38_smalltit[v278x].dword4_height -=
                        v113 >> 10, projectedVertexBuffer[31] >= 14464)) {
                    v113 = 0;
                }
                ...
                if (v110 < str_F2C20ar.dword0x16) {
                    v116 =
                        v116 * (signed __int64)(str_F2C20ar.dword0x16 -
                                                v110) / str_F2C20ar.dword0x12;
 LABEL_133:
 ...
 LABEL_134:
                ...
                Str_E9C38_smalltit[v278x].dword20 =
                    str_F2C20ar.dword0x22 +
                    str_F2C20ar.dword0x18 * Str_E9C38_smalltit[v278x].dword4_height / v109;
                Str_E9C38_smalltit[v278x].dword28 =
                    str_F2C20ar.dword0x22 +
                    str_F2C20ar.dword0x18 * Str_E9C38_smalltit[v117x].dword8 / v109;
                ...
                Str_E9C38_smalltit[v278x].byte43 =
                    Maths::x_BYTE_D41D8[Str_E9C38_smalltit[v278x].byte41];
                Str_E9C38_smalltit[v120x].byte42_std =
                    projectedVertexBuffer[32] +
                    (((signed int)(unsigned __int8)mapAngle_13B4E0[v118] >> 2) & 0x1C);
 ...
 LABEL_256:
        ...
        v200 = v279;
        Str_E9C38_smalltit[v278x].dword16 =
            str_F2C20ar.dword0x18 * Str_E9C38_smalltit[v278x].dword0_rot / v198;
        ...
        v202 =
            projectedVertexBuffer[26] *
            (Maths::sin_DB750[(((unsigned __int8)v279 << 7) + v201) & 0x7FF] >> 8);
        if (!(mapAngle_13B4E0[v200] & 8)
            || (Str_E9C38_smalltit[v278x].dword4_height -= v202 >> 10, v197 >= 14464))
            v202 = 0;
        v203 = (v197 << 8) + 8 * v202;
 ...
 LABEL_254:
                Str_E9C38_smalltit[v278x].dword20 =
                    str_F2C20ar.dword0x22 +
                    str_F2C20ar.dword0x18 * Str_E9C38_smalltit[v278x].dword4_height / v198;
                LOBYTE(v204) = v277[2] + v279;
                HIBYTE(v204) = v277[3] + HIBYTE(v279);
                v205x = v278x;
                Str_E9C38_smalltit[v278x].byte41 = mapTerrainType_10B4E0[v204];
                Str_E9C38_smalltit[v205x].byte43 =
                    Maths::x_BYTE_D41D8[Str_E9C38_smalltit[v205x].byte41];
                Str_E9C38_smalltit[v205x].byte42_std =
                    projectedVertexBuffer[32] +
                    (((signed int)(unsigned __int8)mapAngle_13B4E0[v204] >> 2) & 0x1C);
    ...
    while (v209) {
        ...
        v213 =
            (str_F2C20ar.dword0x0d * Str_E9C38_smalltit[v56x].dword16 +
             str_F2C20ar.dword0x11 * Str_E9C38_smalltit[v56x].dword20) >> 16;
        Str_E9C38_smalltit[v56x].dword16 =
            ((Str_E9C38_smalltit[v56x].dword16 * str_F2C20ar.dword0x11 -
              str_F2C20ar.dword0x0d * Str_E9C38_smalltit[v56x].dword20) >> 16)
            + str_F2C20ar.dword0x24;
        v214 = v212 - v213;
...
void GameRenderHD::SubDrawCaveTerrainAndParticles(std::vector < int >&projectedVertexBuffer,
                                                  int pitch)
{
    int v57x = 800;
    char v58;                   // ah
        ...
        for (jx = v57x;; jx = (v80x + 1)) {
            ...
            if ((v66 & v65 & 0x80u) == 0) {
                if (Str_E9C38_smalltit[v68x].word38 & 0x1000) {
                    x_BYTE_E126D = 7;
                    x_BYTE_E126C =
                        (projectedVertexBuffer[10] + projectedVertexBuffer[16] +
                         projectedVertexBuffer[22] + projectedVertexBuffer[4]) >> 18;
                } else {
                    x_BYTE_E126D = 5;
                }
                if (!(v67 & 2)) {
            ...
            if (v79 >= 0) {
                ...
                if (Str_E9C38_smalltit[v80x].word36)
                    DrawParticles_3E360(v80x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730,
                                        x_DWORD_EA3E4, str_unk_1804B0ar, viewPort, pitch);
            }
            v58 = v293 - 1;
        }
            ...
            do {
                ...
                if (v106 >= 0) {
                    ...
                    if (Str_E9C38_smalltit[v107x].word36)
                        DrawParticles_3E360(v107x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730,
                                            x_DWORD_EA3E4, str_unk_1804B0ar, viewPort, pitch);
                }
                v83x = v107x - 1;
            } while (v83x >= v82x);
...
void GameRenderHD::SubDrawInverseTerrainAndParticles(std::vector < int >&projectedVertexBuffer,
                                                     int pitch)
{
    int v25z;
    int v133x = 800;
    ...
    for (m = 20; m; --m) {
        ...
        for (n = 39; n; --n) {
            ...
            if (Str_E9C38_smalltit[v143x].word36)
                sub_3FD60(v143x, x_BYTE_E88E0x, x_DWORD_EA3E4, str_unk_1804B0ar, str_DWORD_F66F0x,
                          x_DWORD_F5730, viewPort, pitch);
            v134x = v143x + 1;
        }
        ...
        if (n) {
            ...
            do {
                ...
                if (Str_E9C38_smalltit[v155x].word36)
                    sub_3FD60(v155x, x_BYTE_E88E0x, x_DWORD_EA3E4, str_unk_1804B0ar,
                              str_DWORD_F66F0x, x_DWORD_F5730, viewPort, pitch);
                v147x = v155x - 1;
            } while (v147x >= v25z);
        }
        v133x -= 40;
        ...
        for (ii = 39; ii; --ii) {
            ...
            if ((int8_t) (Str_E9C38_smalltit[v172x].word38 & 0xff) >= 0) {
                if (Str_E9C38_smalltit[v172x].word38 & 0x1000) {
                    x_BYTE_E126D = 7;
                    x_BYTE_E126C =
                        ((signed int)projectedVertexBuffer[10] + projectedVertexBuffer[16] +
                         projectedVertexBuffer[22] + projectedVertexBuffer[4]) >> 18;
                } else {
                    x_BYTE_E126D = 5;
                }
            ...
            if (Str_E9C38_smalltit[v172x].word36)
                DrawParticles_3E360(v172x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730,
                                    x_DWORD_EA3E4, str_unk_1804B0ar, viewPort, pitch);
            v161 = v172x + 1;
        }
        ...
        if (ii) {
            ...
            do {
                ...
                if (Str_E9C38_smalltit[v190x].word36)
                    DrawParticles_3E360(v190x, str_DWORD_F66F0x, x_BYTE_E88E0x, x_DWORD_F5730,
                                        x_DWORD_EA3E4, str_unk_1804B0ar, viewPort, pitch);
                v178x = v190x - 1;
            } while (v178x >= v177x);
        }
...
uint16_t GameRenderHD::sub_3FD60(int a2x, uint8_t x_BYTE_E88E0x[],
                                 ...
                                 ViewPort viewPort, uint16_t screenWidth)
{
            ...
            if (!(v3x->struct_byte_0xc_12_15.byte[0] & 0x21)) {
                ...
                if (v7 > 64 && v8 < str_F2C20ar.dword0x15) {
                    if (v8 <= str_F2C20ar.dword0x13) {
                        ...
                        str_F2C20ar.dword0x00 =
                            32 * (str_F2C20ar.dword0x16 -
                                  (v40 * v40 + v6 * v6)) / str_F2C20ar.dword0x12 << 8;
                    } else {
                    ...
                    str_F2C20ar.dword0x04_screenY =
                        ((v10 * str_F2C20ar.dword0x11 - str_F2C20ar.dword0x0d * v11) >> 16) +
                        str_F2C20ar.dword0x24;
                    str_F2C20ar.dword0x03_screenX =
                        str_F2C20ar.dword0x10 -
                        ((str_F2C20ar.dword0x0d * v10 + v11 * str_F2C20ar.dword0x11) >> 16);
                    v12 = v9x->byte_12;
                    x_BYTE_F2CC6 = 0;
                    switch (v12) {
                    case 0:
                        ...
                        if (MainInitTmaps_71520(v9x->word_0)) {
                            ...
                            //v15 = 4 * v14;
 LABEL_16:
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v9x->word_0].word_8] =
                                engine_db.byteindex_26;
                    ...
                    case 17:
                        v26 =
                            (((v41x->word_0x1C_28 - (unsigned __int16)yaw_F2CC0) >> 3) & 0xF0) >> 4;
                        if (v26 < 8) {
                            if (str_DWORD_F66F0x[v26 + v9x->word_0]) {
                                x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v26 + v9x->word_0].
                                              word_8] = engine_db.byteindex_26;
                            } else {
                        ...
                        if (str_DWORD_F66F0x[v9x->word_0 + 15 - v26]) {
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v9x->word_0 + 15 - v26].
                                          word_8] = engine_db.byteindex_26;
                        } else {
                        ...
                        str_F2C20ar.dword0x09_realWidth =
                            v28 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                    ...
                    case 18:
                        ...
                        if (str_DWORD_F66F0x[v30]) {
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v30].word_8] =
                                engine_db.byteindex_26;
                        } else {
                            if (!MainInitTmaps_71520(v29 + v9x->word_0))
                                break;
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v29 + v9x->word_0].word_8] =
                                engine_db.byteindex_26;
                        }
                        ...
                        str_F2C20ar.dword0x09_realWidth =
                            v31 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                        v23 = str_F2C20ar.dword0x08_width;
                        goto LABEL_69;
                    case 19:
                        v19 =
                        ...
                        if (v19 >= 8) {
                            ...
                            if (!str_DWORD_F66F0x[v24]) {
                                if (!MainInitTmaps_71520
                                    (v9x->word_0 + (unsigned __int8)x_BYTE_D4750[12 + v19]))
                                    break;
                                v24 = v9x->word_0 + (unsigned __int8)x_BYTE_D4750[12 + v19];
                            }
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v24].word_8] =
                                engine_db.byteindex_26;
                            a1x =
                                *str_DWORD_F66F0x[v9x->word_0 +
                                                  (unsigned __int8)x_BYTE_D4750[12 + v19]];
                            str_F2C20ar.dword0x08_width = a1x->width;
                            str_F2C20ar.dword0x06_height = a1x->height;
                            v25 = (signed __int64)(str_F2C20ar.dword0x18 * v9x->rotSpeed_8) / v40;
                            str_F2C20ar.dword0x0c_realHeight = v25;
                            str_F2C20ar.dword0x09_realWidth =
                                v25 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                            v23 = -str_F2C20ar.dword0x08_width;
                        } else {
                            v20 = (unsigned __int8)x_BYTE_D4750[12 + v19];
                            v21 = v20 + v9x->word_0;
                            if (str_DWORD_F66F0x[v21]) {
                                x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v21].word_8] =
                                    engine_db.byteindex_26;
                            } else {
                                ...
                                x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                              [v9x->word_0 +
                                               (unsigned __int8)x_BYTE_D4750[12 + v19]].word_8] =
                                    engine_db.byteindex_26;
                            }
                            a1x =
                                *str_DWORD_F66F0x[v9x->word_0 +
                            ...
                            str_F2C20ar.dword0x09_realWidth =
                                v22 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                            v23 = str_F2C20ar.dword0x08_width;
                        }
                        goto LABEL_69;
                    case 20:
                        ...
                        if (v32 >= 8) {
                            ...
                            if (str_DWORD_F66F0x[v35]) {
                                x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v35].word_8] =
                                    engine_db.byteindex_26;
                            } else {
                                if (!MainInitTmaps_71520
                                    (v9x->word_0 + (unsigned __int8)x_BYTE_D4750[28 + v32]))
                                    break;
                                x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                              [v9x->word_0 +
                                               (unsigned __int8)x_BYTE_D4750[28 + v32]].word_8] =
                                    engine_db.byteindex_26;
                            }
                            a1x =
                                *str_DWORD_F66F0x[(unsigned __int8)x_BYTE_D4750[28 + v32] +
                                                  v9x->word_0];
                            str_F2C20ar.dword0x08_width = a1x->width;
                            str_F2C20ar.dword0x06_height = a1x->height;
                            ...
                            str_F2C20ar.dword0x09_realWidth =
                                v36 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                            v23 = -str_F2C20ar.dword0x08_width;
                        } else {
                            v33 = v9x->word_0 + (unsigned __int8)x_BYTE_D4750[28 + v32];
                            if (str_DWORD_F66F0x[v33]) {
                                x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v33].word_8] =
                                    engine_db.byteindex_26;
                            } else {
                                if (!MainInitTmaps_71520
                                    (v9x->word_0 + (unsigned __int8)x_BYTE_D4750[28 + v32]))
                            ...
                            a1x =
                                *str_DWORD_F66F0x[v9x->word_0 +
                                                  (unsigned __int8)x_BYTE_D4750[28 + v32]];
                            str_F2C20ar.dword0x08_width = a1x->width;
                            str_F2C20ar.dword0x06_height = a1x->height;
                            v34 = (signed __int64)(str_F2C20ar.dword0x18 * v9x->rotSpeed_8) / v40;
                            str_F2C20ar.dword0x0c_realHeight = v34;
                            str_F2C20ar.dword0x09_realWidth =
                                v34 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                            v23 = str_F2C20ar.dword0x08_width;
                        }
                        goto LABEL_69;
                    case 21:
                        ...
                        if (str_DWORD_F66F0x[v16]) {
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v16].word_8] =
                                engine_db.byteindex_26;
                        } else {
 ...
 LABEL_26:
                        ...
                        if (str_DWORD_F66F0x[v18]) {
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v18].word_8] =
                                engine_db.byteindex_26;
                        } else {
                            if (!MainInitTmaps_71520(v9x->word_0 + v41x->byte_0x5C_92))
                                break;
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                          [v9x->word_0 + v41x->byte_0x5C_92].word_8] =
                                engine_db.byteindex_26;
                        }
 ...
 LABEL_47:
                        ...
                        str_F2C20ar.dword0x09_realWidth =
                            v27 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                        v23 = str_F2C20ar.dword0x08_width;
 LABEL_69:
...
void GameRenderHD::sub_88740(event_t *a1x, int a2, int a3)
{
    int v3;                     // esi
    event_t *v4x;     // edx
 ...
 LABEL_30:
            ...
            if (v8 < 0xE8u || v8 > 0xEAu) {
                v10 = 1;
                if ((a1x->StageVar2_0x49_73 == 14 || a1x->StageVar2_0x49_73 == 13)
                    && a1x->parentId_0x28_40 == v4x->id_0x1A_26)
                    v10 = 0;
                if (v10)
                    v3 = 19;
            }
...
void GameRenderHD::SetBillboards_3B560(int16_t roll)
{
    ...
    case 0:
        ...
        str_F2C20ar.dword0x1c =
            (unsigned __int16)viewPort.Height_DE568 + (unsigned __int16)viewPort.Width_DE564;
...
void GameRenderHD::DrawSorcererNameAndHealthBar_2CB30(event_t *a1x, __int16 a2, int a3,
                                                      __int16 a4)
{
    char *v5;                   // esi
    int v9x;                    // eax
    ...
    if (v11 >= viewPort.PosX_EA3D0) {
        if ((signed __int16)v12 >= viewPort.PosY_EA3CC && v11 < v31 && (signed __int16)v12 < v29) {
            ...
            if (v11 + v13 > v31) {
                v13 = v31 - v11;
                v9x =
                    ((v31 - v11 - 4) - (my_sign32(v31 - v11 - 4) << 3) +
                     my_sign32(v31 - v11 - 4)) >> 3;
            }
            if (v9x > 0) {
                v24[v9x] = 0;
                v32 = v13 + 2;
...
void GameRenderHD::DrawSquareInProjectionSpace(std::vector < int >&vertexs, int index)
{
    ...
    if ((uint8_t) Str_E9C38_smalltit[index].word38 & 1) {
        if (m_renderThreads.size() > 0) {
            ...
            for (i = 0; i < m_renderThreads.size(); i++) {
                m_renderThreads[i]->
                    Run([this, vertex0, vertex6, vertex12, vertex18, i, drawEveryNthLine] {
                        this->DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex12, &vertex0, i,
                                                                  drawEveryNthLine);
                        this->DrawTriangleInProjectionSpace_B6253(&vertex0, &vertex12, &vertex6, i,
                                                                  drawEveryNthLine);}
                );
            }
        ...
        if (m_renderThreads.size() > 0) {
            ...
            for (i = 0; i < m_renderThreads.size(); i++) {
                m_renderThreads[i]->
                    Run([this, vertex0, vertex6, vertex12, vertex18, i, drawEveryNthLine] {
                        this->DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex12, &vertex6, i,
                                                                  drawEveryNthLine);
                        this->DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex6, &vertex0, i,
                                                                  drawEveryNthLine);}
                );
            }
    ...
    if (Str_E9C38_smalltit[index].word38 & 1) {
        if (m_renderThreads.size() > 0) {
            ...
            for (i = 0; i < m_renderThreads.size(); i++) {
                m_renderThreads[i]->
                    Run([this, vertex0, vertex6, vertex12, vertex18, i, drawEveryNthLine] {
                        this->DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex0, &vertex12, i,
                                                                  drawEveryNthLine);
                        this->DrawTriangleInProjectionSpace_B6253(&vertex0, &vertex6, &vertex12, i,
                                                                  drawEveryNthLine);}
                );
            }
        ...
        if (m_renderThreads.size() > 0) {
            ...
            for (i = 0; i < m_renderThreads.size(); i++) {
                m_renderThreads[i]->
                    Run([this, vertex0, vertex6, vertex12, vertex18, i, drawEveryNthLine] {
                        this->DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex6, &vertex12, i,
                                                                  drawEveryNthLine);
                        this->DrawTriangleInProjectionSpace_B6253(&vertex18, &vertex0, &vertex6, i,
                                                                  drawEveryNthLine);}
                );
            }
...
void GameRenderHD::DrawParticles_3E360(int a2x, type_particle_str **str_DWORD_F66F0x[],
                                       ...
                                       uint16_t screenWidth)
{
                ...
                if (!Str_E9C38_smalltit[a2x].byte43
                    ...
                    if (v99 > 64 && v6 < str_F2C20ar.dword0x15) {
                        if (v6 <= str_F2C20ar.dword0x13)
                            ...
                            str_F2C20ar.dword0x00 =
                                v6 <
                                str_F2C20ar.dword0x16 ? 32 * (str_F2C20ar.dword0x16 -
                                                              (v99 * v99 +
                                                               v5 * v5)) /
                                str_F2C20ar.dword0x12 << 8 : 0;
                        ...
                        if (!v7x->byte_10) {
                            ...
                            str_F2C20ar.dword0x04_screenY =
                                ((v8 * str_F2C20ar.dword0x11 - str_F2C20ar.dword0x0d * v9) >> 16) +
                                str_F2C20ar.dword0x24;
                            str_F2C20ar.dword0x03_screenX =
                                str_F2C20ar.dword0x10 -
                                ((str_F2C20ar.dword0x0d * v8 + v9 * str_F2C20ar.dword0x11) >> 16);
                            v10 = v7x->byte_12;
                            x_BYTE_F2CC6 = 0;
                            switch (v10) {
                            case 0:
                                ...
                                x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v7x->word_0].word_8] =
                                    engine_db.byteindex_26;
                                a1y = *str_DWORD_F66F0x[v7x->word_0];
                                goto LABEL_51;
                            case 1:
                                if (!str_DWORD_F66F0x[v7x->word_0]
                                    && !MainInitTmaps_71520(v7x->word_0))
                                    goto LABEL_178;
                                x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v7x->word_0].word_8] =
                                    engine_db.byteindex_26;
                                a1y = *str_DWORD_F66F0x[v7x->word_0];
                            ...
                            case 17:
                                v25 =
                                    (((str_F2C20ar.dword0x14x->word_0x1C_28 -
                                ...
                                if (v25 < 8) {
                                    ...
                                    x_DWORD_F5730[v27] = engine_db.byteindex_26;
                                    a1y = *str_DWORD_F66F0x[v25 + v7x->word_0];
                                    goto LABEL_51;
                                }
                                if (str_DWORD_F66F0x[v7x->word_0 + 15 - v25]) {
                                    v30 =
                                        str_TMAPS00TAB_BEGIN_BUFFER[v7x->word_0 + 15 - v25].word_8;
                                } else {
                                ...
                                x_DWORD_F5730[v30] = engine_db.byteindex_26;
                                a1y = *str_DWORD_F66F0x[v7x->word_0 + 15 - v25];
                                str_F2C20ar.dword0x08_width = a1y->width;
                                str_F2C20ar.dword0x06_height = a1y->height;
                                v31 =
                                    (signed __int64)(str_F2C20ar.dword0x18 * v7x->rotSpeed_8) / v99;
                                str_F2C20ar.dword0x0c_realHeight = v31;
                                str_F2C20ar.dword0x09_realWidth =
                                    v31 * str_F2C20ar.dword0x08_width /
                                    str_F2C20ar.dword0x06_height;
                            ...
                            case 18:
                                ...
                                x_DWORD_F5730[v35] = engine_db.byteindex_26;
                                ...
                                str_F2C20ar.dword0x0c_realHeight = v36;
                                str_F2C20ar.dword0x09_realWidth =
                                    v36 * str_F2C20ar.dword0x08_width /
                                    str_F2C20ar.dword0x06_height;
                                v21 = str_F2C20ar.dword0x08_width;
                                goto LABEL_72;
                            case 19:
                                ...
                                if (v18 >= 8) {
                                    ...
                                    if (str_DWORD_F66F0x[v23]) {
                                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v23].word_8] =
                                            engine_db.byteindex_26;
                                    } else {
                                        if (!MainInitTmaps_71520
                                            (v7x->word_0 + (unsigned __int8)v22))
                                            goto LABEL_178;
                                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                                      [v7x->word_0 +
                                                       (unsigned __int8)x_BYTE_D4750[12 +
                                                                                     v18]].word_8] =
                                            engine_db.byteindex_26;
                                    }
                                    a1y =
                                        *str_DWORD_F66F0x[v7x->word_0 +
                                                          (unsigned __int8)x_BYTE_D4750[12 + v18]];
                                    str_F2C20ar.dword0x08_width = a1y->width;
                                    str_F2C20ar.dword0x06_height = a1y->height;
                                    v24 =
                                        (signed __int64)(str_F2C20ar.dword0x18 * v7x->rotSpeed_8) /
                                        v99;
                                    str_F2C20ar.dword0x0c_realHeight = v24;
                                    str_F2C20ar.dword0x09_realWidth =
                                        v24 * str_F2C20ar.dword0x08_width /
                                        str_F2C20ar.dword0x06_height;
                                    v21 = -str_F2C20ar.dword0x08_width;
                                } else {
                                    v19 = (unsigned __int8)x_BYTE_D4750[12 + v18] + v7x->word_0;
                                    if (str_DWORD_F66F0x[v19]) {
                                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v19].word_8] =
                                            engine_db.byteindex_26;
                                    } else {
                                        if (!MainInitTmaps_71520
                                            (v7x->word_0 + (unsigned __int8)x_BYTE_D4750[12 + v18]))
                                            goto LABEL_178;
                                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                                      [v7x->word_0 +
                                                       (unsigned __int8)x_BYTE_D4750[12 +
                                    ...
                                    str_F2C20ar.dword0x09_realWidth =
                                        v20 * str_F2C20ar.dword0x08_width /
                                        str_F2C20ar.dword0x06_height;
                                    v21 = str_F2C20ar.dword0x08_width;
                                }
                                goto LABEL_72;
                            case 20:
                                ...
                                if (v37 >= 8) {
                                    ...
                                    if (!str_DWORD_F66F0x[v41]) {
                                        if (!MainInitTmaps_71520
                                            (v7x->word_0 + (unsigned __int8)x_BYTE_D4750[28 + v37]))
                                            goto LABEL_178;
                                        v41 = (unsigned __int8)x_BYTE_D4750[28 + v37] + v7x->word_0;
                                    }
                                    x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v41].word_8] =
                                        engine_db.byteindex_26;
                                    a1y =
                                        *str_DWORD_F66F0x[v7x->word_0 +
                                                          (unsigned __int8)x_BYTE_D4750[28 + v37]];
                                    str_F2C20ar.dword0x08_width = a1y->width;
                                    str_F2C20ar.dword0x06_height = a1y->height;
                                    v42 =
                                        (signed __int64)(str_F2C20ar.dword0x18 * v7x->rotSpeed_8) /
                                    ...
                                    str_F2C20ar.dword0x09_realWidth =
                                        v42 * str_F2C20ar.dword0x08_width /
                                        str_F2C20ar.dword0x06_height;
                                    v21 = -str_F2C20ar.dword0x08_width;
                                } else {
                                    ...
                                    if (str_DWORD_F66F0x[v39]) {
                                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v39].word_8] =
                                            engine_db.byteindex_26;
                                    } else {
                                        if (!MainInitTmaps_71520
                                            (v7x->word_0 + (unsigned __int8)v38))
                                            goto LABEL_178;
                                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                                      [v7x->word_0 +
                                                       (unsigned __int8)x_BYTE_D4750[28 +
                                                                                     v37]].word_8] =
                                            engine_db.byteindex_26;
                                    }
                                    a1y =
                                    ...
                                    str_F2C20ar.dword0x09_realWidth =
                                        v40 * str_F2C20ar.dword0x08_width /
                                        str_F2C20ar.dword0x06_height;
                                    v21 = str_F2C20ar.dword0x08_width;
                                }
                                goto LABEL_72;
 ...
 LABEL_29:
                                ...
                                if (str_DWORD_F66F0x[v17]) {
                                    x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v17].word_8] =
                                        engine_db.byteindex_26;
                                } else {
                                    if (!MainInitTmaps_71520
                                        (v7x->word_0 + str_F2C20ar.dword0x14x->byte_0x5C_92))
                                        goto LABEL_178;
                                    x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                                  [v7x->word_0 +
                                                   str_F2C20ar.dword0x14x->byte_0x5C_92].word_8] =
                                        engine_db.byteindex_26;
                                }
                                a1y =
                                    (type_particle_str *) * str_DWORD_F66F0x[v7x->word_0 +
                                                                             str_F2C20ar.
                                                                             dword0x14x->
                                                                             byte_0x5C_92];
 LABEL_51:
                                ...
                                str_F2C20ar.dword0x0c_realHeight = v28;
                                str_F2C20ar.dword0x09_realWidth =
                                    v28 * str_F2C20ar.dword0x08_width /
                                    str_F2C20ar.dword0x06_height;
                                v21 = str_F2C20ar.dword0x08_width;
 LABEL_72:
 ...
 LABEL_73:
            ...
            if (v100 > 64 && v51 < str_F2C20ar.dword0x15) {
                if (v51 <= str_F2C20ar.dword0x13) {
                    ...
                    str_F2C20ar.dword0x00 =
                        32 * (str_F2C20ar.dword0x16 -
                              (v100 * v100 + v49 * v49)) / str_F2C20ar.dword0x12 << 8;
                } else {
                    str_F2C20ar.dword0x00 = 0;
                }
                ...
                v54 =
                    str_F2C20ar.dword0x18 * (v48 - str_F2C20ar.dword0x20) / v100 +
                    str_F2C20ar.dword0x22;
                str_F2C20ar.dword0x04_screenY =
                    ((v53 * str_F2C20ar.dword0x11 - str_F2C20ar.dword0x0d * v54) >> 16) +
                    str_F2C20ar.dword0x24;
                str_F2C20ar.dword0x03_screenX =
                    str_F2C20ar.dword0x10 -
                    ((str_F2C20ar.dword0x0d * v53 + v54 * str_F2C20ar.dword0x11) >> 16);
                v55 = v52x->byte_12;
                x_BYTE_F2CC6 = 0;
                switch (v55) {
                case 0:
 ...
 LABEL_105:
                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v52x->word_0].word_8] =
                            engine_db.byteindex_26;
                ...
                case 17:
                    ...
                    if (v72 < 8) {
                        ...
                        x_DWORD_F5730[v75] = engine_db.byteindex_26;
                        a1y = *str_DWORD_F66F0x[v52x->word_0 + v72];
                        goto LABEL_141;
                    }
                    v77 = v52x->word_0 + 15 - v72;
                    if (str_DWORD_F66F0x[v77]) {
                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v77].word_8] =
                            engine_db.byteindex_26;
                    } else {
                        if (!MainInitTmaps_71520(v52x->word_0 + 15 - v72))
                            break;
                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v52x->word_0 + 15 - v72].word_8] =
                            engine_db.byteindex_26;
                    }
                    ...
                    str_F2C20ar.dword0x09_realWidth =
                        v78 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                ...
                case 18:
                    ...
                    if (str_DWORD_F66F0x[v80]) {
                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v80].word_8] =
                            engine_db.byteindex_26;
                    } else {
                        if (!MainInitTmaps_71520(v79 + v52x->word_0))
                            break;
                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v79 + v52x->word_0].word_8] =
                            engine_db.byteindex_26;
                    }
                    ...
                    str_F2C20ar.dword0x09_realWidth =
                        v81 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                    v67 = str_F2C20ar.dword0x08_width;
                    goto LABEL_163;
                case 19:
                    v62 =
                    ...
                    if (v62 >= 8) {
                        ...
                        if (str_DWORD_F66F0x[v68]) {
                            ...
                            if (!MainInitTmaps_71520
                                (v52x->word_0 + (unsigned __int8)x_BYTE_D4750[12 + v62]))
                                break;
                            v70 =
                                str_TMAPS00TAB_BEGIN_BUFFER[v52x->word_0 +
                                                            (unsigned __int8)x_BYTE_D4750[12 +
                                                                                          v62]].
                                word_8;
                        }
                        x_DWORD_F5730[v70] = engine_db.byteindex_26;
                        a1y =
                            *str_DWORD_F66F0x[v52x->word_0 +
                                              (unsigned __int8)x_BYTE_D4750[12 + v62]];
                        str_F2C20ar.dword0x08_width = a1y->width;
                        str_F2C20ar.dword0x06_height = a1y->height;
                        v71 = (signed __int64)(str_F2C20ar.dword0x18 * v52x->rotSpeed_8) / v100;
                        str_F2C20ar.dword0x0c_realHeight = v71;
                        str_F2C20ar.dword0x09_realWidth =
                            v71 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                        v67 = -str_F2C20ar.dword0x08_width;
                    } else {
                        ...
                        if (str_DWORD_F66F0x[v63]) {
                            ...
                            if (!MainInitTmaps_71520
                                ...
                                break;
                            v65 =
                                str_TMAPS00TAB_BEGIN_BUFFER[(unsigned __int8)x_BYTE_D4750[12 + v62]
                                                            + v52x->word_0].word_8;
                        }
                        x_DWORD_F5730[v65] = engine_db.byteindex_26;
                        a1y =
                            *str_DWORD_F66F0x[v52x->word_0 +
                                              (unsigned __int8)x_BYTE_D4750[12 + v62]];
                        str_F2C20ar.dword0x08_width = a1y->width;
                        ...
                        str_F2C20ar.dword0x09_realWidth =
                            v66 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                        v67 = str_F2C20ar.dword0x08_width;
                    }
                    goto LABEL_163;
                case 20:
                    ...
                    if (v82 >= 8) {
                        ...
                        if (str_DWORD_F66F0x[v86]) {
                            ...
                            if (!MainInitTmaps_71520
                                (v52x->word_0 + (unsigned __int8)x_BYTE_D4750[28 + v82]))
                                break;
                            v88 =
                                str_TMAPS00TAB_BEGIN_BUFFER[v52x->word_0 +
                                                            (unsigned __int8)x_BYTE_D4750[28 +
                        ...
                        x_DWORD_F5730[v88] = engine_db.byteindex_26;
                        a1y =
                            *str_DWORD_F66F0x[v52x->word_0 +
                                              (unsigned __int8)x_BYTE_D4750[28 + v82]];
                        str_F2C20ar.dword0x08_width = a1y->width;
                        str_F2C20ar.dword0x06_height = a1y->height;
                        v89 = (signed __int64)(str_F2C20ar.dword0x18 * v52x->rotSpeed_8) / v100;
                        str_F2C20ar.dword0x0c_realHeight = v89;
                        str_F2C20ar.dword0x09_realWidth =
                            v89 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                        v67 = -str_F2C20ar.dword0x08_width;
                    } else {
                        v83 = (unsigned __int8)x_BYTE_D4750[28 + v82];
                        v84 = v83 + v52x->word_0;
                        if (str_DWORD_F66F0x[v84]) {
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v84].word_8] =
                                engine_db.byteindex_26;
                        } else {
                            ...
                            x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                          [v52x->word_0 +
                                           (unsigned __int8)x_BYTE_D4750[28 + v82]].word_8] =
                                engine_db.byteindex_26;
                        }
                        a1y =
                            *str_DWORD_F66F0x[v52x->word_0 +
                        ...
                        str_F2C20ar.dword0x09_realWidth =
                            v85 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                        v67 = str_F2C20ar.dword0x08_width;
                    }
                    goto LABEL_163;
                case 21:
                    ...
                    if (str_DWORD_F66F0x[v59]) {
                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v59].word_8] =
                            engine_db.byteindex_26;
                    } else {
 ...
 LABEL_117:
                    ...
                    if (str_DWORD_F66F0x[v61]) {
                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER[v61].word_8] =
                            engine_db.byteindex_26;
                    } else {
                        if (!MainInitTmaps_71520
                            (v52x->word_0 + str_F2C20ar.dword0x14x->byte_0x5C_92))
                            break;
                        x_DWORD_F5730[str_TMAPS00TAB_BEGIN_BUFFER
                                      [v52x->word_0 +
                                       str_F2C20ar.dword0x14x->byte_0x5C_92].word_8] =
 ...
 LABEL_141:
                    ...
                    str_F2C20ar.dword0x09_realWidth =
                        v76 * str_F2C20ar.dword0x08_width / str_F2C20ar.dword0x06_height;
                    v67 = str_F2C20ar.dword0x08_width;
 LABEL_163:
...
void GameRenderHD::DrawSprite_41BD3(uint32 a1)
{
    ...
    if (!x_BYTE_F2CC6) {
        if (a1 < 1) {
            ...
            {
                str_F2C20ar.dword0x04_screenY -=
                    ((str_F2C20ar.dword0x11 * str_F2C20ar.dword0x09_realWidth >> 1) +
                     str_F2C20ar.dword0x0d * str_F2C20ar.dword0x0c_realHeight) >> 16;
                str_F2C20ar.dword0x03_screenX -=
                    (str_F2C20ar.dword0x11 * str_F2C20ar.dword0x0c_realHeight -
                     (str_F2C20ar.dword0x0d * str_F2C20ar.dword0x09_realWidth >> 1)) >> 16;
                goto LABEL_126;
            }
            if (a1 != 2)        //a1 == 0,1
            {
 LABEL_126:
                if ((unsigned int)str_F2C20ar.dword0x1e <= 7) {
                    ...
                    case 0:
                        ...
                        if (str_F2C20ar.dword0x03_screenX -
                            (str_F2C20ar.dword0x1f * str_F2C20ar.dword0x04_screenY >> 16) >=
                            str_F2C20ar.dword0x21)
                            goto LABEL_136;
 ...
 LABEL_136:
                    ...
                    case 1:
                        ...
                        if (str_F2C20ar.dword0x04_screenY -
                            (str_F2C20ar.dword0x1f * str_F2C20ar.dword0x03_screenX >> 16) <
 ...
 LABEL_284:
                    ...
                    case 2:
                        ...
                        v170 =
                            str_F2C20ar.width0x25 - str_F2C20ar.dword0x04_screenY -
                            (str_F2C20ar.dword0x1f * str_F2C20ar.dword0x03_screenX >> 16);
 ...
 LABEL_329:
                    ...
                    case 3:
                        ...
                        v171 =
                            str_F2C20ar.dword0x03_screenX -
                            (str_F2C20ar.dword0x1f *
                             (str_F2C20ar.height0x26 - str_F2C20ar.dword0x04_screenY) >> 16);
                        if (str_F2C20ar.dword0x03_screenX -
                            (str_F2C20ar.dword0x1f *
                             (str_F2C20ar.height0x26 - str_F2C20ar.dword0x04_screenY) >> 16) <
                            str_F2C20ar.width0x25) {
                        ...
                        v123 =
                            str_F2C20ar.height0x26 + iScreenWidth_DE560 * v171 - 1 +
                    ...
                    case 4:
                        ...
                        v170 =
                            str_F2C20ar.width0x25 - str_F2C20ar.dword0x03_screenX -
                            (str_F2C20ar.dword0x1f *
                             (str_F2C20ar.height0x26 - str_F2C20ar.dword0x04_screenY) >> 16);
                        if (v170 >= str_F2C20ar.dword0x21)
                            goto LABEL_348;
 ...
 LABEL_348:
                        v123 =
                            str_F2C20ar.height0x26 + ViewPortRenderBufferStart_DE558 +
                            iScreenWidth_DE560 * (str_F2C20ar.width0x25 - v170 - 1) - 1;
                        goto LABEL_137;
                    case 5:
                        v156 = str_F2C20ar.dword0x27 * str_F2C20ar.dword0x09_realWidth >> 16;
                        if (v156 <= 0)
                        ...
                        v123 =
                            (str_F2C20ar.height0x26 - 1) * iScreenWidth_DE560 +
                            str_F2C20ar.width0x25 + ViewPortRenderBufferStart_DE558 - 1 - v171;
                        goto LABEL_285;
                    case 6:
                        v156 = str_F2C20ar.dword0x1b * str_F2C20ar.dword0x09_realWidth >> 16;
                        if (v156 <= 0)
 ...
 LABEL_367:
                        v123 =
                            ViewPortRenderBufferStart_DE558 +
                            iScreenWidth_DE560 * (str_F2C20ar.height0x26 - 1) + v170;
 LABEL_137:
 ...
 LABEL_154:
                        if (v170 + v159 > str_F2C20ar.Height_0x19) {
                            if (str_F2C20ar.Height_0x19 - v170 <= 0) {
                                ...
                                v117 =
                                    (x_DWORD *) (4 * (str_F2C20ar.Height_0x19 - v170) +
                                                 str_F2C20ar.pbyte0x1a);
                                v125 = v159;
                            } else {
                                v163 =
                                    (x_DWORD *) (12 * (str_F2C20ar.Height_0x19 - v170) +
                                                 &x_DWORD_E9C38_smalltit[45920]);
                        ...
                        if (v156 - v116 > 0) {
                            ...
                            for (i = v159; i; i--) {
                                ...
                                if ((v133 > 0) && (*v165 > 0)) {
                                    ...
                                    v121x =
                                        &str_F2C20ar.dword0x02_data[str_F2C20ar.dword0x08_width *
                                                                    (str_F2C20ar.
                                                                     dword0x0a_actIdx >> 16)];
                                    if ((unsigned int)str_F2C20ar.dword0x01_rotIdx <= 8) {
                                        ...
                                        case 0:
                                            ...
                                            v53 =
                                                (x_DWORD *) (8 * (v165[2] - v116) +
                                                             &x_DWORD_E9C38_smalltit[36960]);
                                        ...
                                        case 7:
                                            ...
                                            do {
                                                ...
                                                if ((x_BYTE) v101) {
                                                    BYTE1(v101) = *v100;
                                                    LOBYTE(v98) =
                                                        x_BYTE_F6EE0_tablesx[16384 + v101];
 ...
 LABEL_267:
                    ...
                    case 7:
                        ...
                        v123 =
                            iScreenWidth_DE560 * (str_F2C20ar.width0x25 - 1 - v171) +
                            ViewPortRenderBufferStart_DE558;
 LABEL_285:
                        ...
                        if (v143 > 0) {
                            ...
                            for (k = v171 + str_F2C20ar.dword0x1d - str_F2C20ar.width0x25 + 2; k;
                                 k--) {
                                v167 -= 3;
                ...
                if (a1 == 1) {
                    if (!engine_db.byteindex_207
                        && str_F2C20ar.dword0x14x->class_0x3F_63 == 3
                        && (!str_F2C20ar.dword0x14x->model_0x40_64
                            || str_F2C20ar.dword0x14x->model_0x40_64 == 1)) {
                        DrawSorcererNameAndHealthBar_2CB30(str_F2C20ar.dword0x14x,
                                                           str_F2C20ar.dword0x04_screenY,
                                                           (signed __int16)str_F2C20ar.
                                                           dword0x03_screenX,
                                                           str_F2C20ar.dword0x09_realWidth);
                    }
                    if (engine_db.byteindex_10)
                        sub_88740(str_F2C20ar.dword0x14x,
                                  (signed __int16)(str_F2C20ar.dword0x04_screenY +
                                                   (str_F2C20ar.dword0x09_realWidth >> 1)),
                                  (signed __int16)(str_F2C20ar.dword0x03_screenX +
        ...
        str_F2C20ar.dword0x04_screenY -=
            str_F2C20ar.dword0x11 * str_F2C20ar.dword0x09_realWidth >> 17;
        str_F2C20ar.dword0x03_screenX -=
            -(str_F2C20ar.dword0x0d * str_F2C20ar.dword0x09_realWidth) >> 17;
        goto LABEL_126;
    }
    ...
    if ((unsigned __int16)viewPort.Width_DE564 > str_F2C20ar.dword0x04_screenY) {
        ...
        if (-str_F2C20ar.dword0x04_screenY < 0 || str_F2C20ar.dword0x04_screenY == 0) {
            str_F2C20ar.dword0x0b = 0;
            if (str_F2C20ar.dword0x09_realWidth + str_F2C20ar.dword0x04_screenY -
                (unsigned __int16)viewPort.Width_DE564 > 0)
                str_F2C20ar.dword0x09_realWidth -=
        ...
        if ((unsigned __int16)viewPort.Height_DE568 > str_F2C20ar.dword0x03_screenX) {
            ...
            if (-str_F2C20ar.dword0x03_screenX < 0 || str_F2C20ar.dword0x03_screenX == 0) {
                str_F2C20ar.dword0x0a_actIdx = 0;
                if (str_F2C20ar.dword0x0c_realHeight + str_F2C20ar.dword0x03_screenX -
                    (unsigned __int16)viewPort.Height_DE568 > 0)
                    str_F2C20ar.dword0x0c_realHeight -=
            ...
            if (a1 == 1 && engine_db.byteindex_10)
                sub_88740(str_F2C20ar.dword0x14x,
                          (signed __int16)(str_F2C20ar.dword0x04_screenY +
                                           (str_F2C20ar.dword0x09_realWidth >> 1)),
                          (signed __int16)(str_F2C20ar.dword0x03_screenX +
            ...
            //               screen-Y                                            screen-X
            v122x =
                &ViewPortRenderBufferStart_DE558[str_F2C20ar.dword0x03_screenX *
                                                 iScreenWidth_DE560 +
                                                 str_F2C20ar.dword0x04_screenY];
            //height
 ...
 LABEL_45:
                    ...
                    case 1:
                        ...
                        v14 =
                            (x_BYTE *) (str_F2C20ar.dword0x08_width *
                                        (str_F2C20ar.dword0x0a_actIdx >> 16) +
                                        str_F2C20ar.dword0x02_data +
                                        *(x_DWORD *) (x_DWORD_E9C38_smalltit + 36964));
...
void GameRenderHD::DrawTriangleInProjectionSpace_B6253(const ProjectionPolygon *vertex1,
                                                       const ProjectionPolygon *vertex2,
                                                       const ProjectionPolygon *vertex3,
                                                       uint8_t startLine, uint8_t drawEveryNthLine)
{
 ...
 LABEL_121:
                            v62 =
                                LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v58, &v59, v1103,
                                            v1107, &v1117);
                            v61 = v1121;
 LABEL_124:
                            if (v1296) {
                    ...
                    case 0x11:
                        ...
                        if (!v48)
                            v1146 =
                                (signed int)(v4->Brightness +
                                             (unsigned __int64)(v1117 *
                                                                (signed __int64)(v3->Brightness -
                                                                                 v5->Brightness) /
                                                                v1113) - v3->Brightness)
                                / (v49 + 1);
 ...
 LABEL_102:
                                if (v1296) {
                                    ...
                                    v55 =
                                        LoadPolygon(v55, &v50, &v54, &v52, v1103, v1111, v1148,
                                                    &v1119);
                                    v31 = (unsigned __int8)x_BYTE_E126D;
                                }
                                goto LABEL_53;
                        ...
                        v55 =
                            LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v50, &v51, &v52, v1103,
                                        v1107, v1148, &v1117);
                        v54 = v1121;
                        goto LABEL_102;
                    case 2:
 ...
 LABEL_77:
                                if (v1296) {
                                    ...
                                    v43 =
                                        LoadPolygon(v43, &v37, &v42, &v39, &v40, v1103, v1111,
                                                    v1126, v1137, &v1119);
                                    v31 = (unsigned __int8)x_BYTE_E126D;
                                }
                                goto LABEL_53;
                        ...
                        v43 =
                            LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v37, &v38, &v39, &v40,
                                        v1103, v1107, v1126, v1137, &v1117);
                        v42 = v1121;
                        goto LABEL_77;
                    case 5:
                    case 6:
 ...
 LABEL_51:
                                if (v1296) {
                                    ...
                                    v28 =
                                        LoadPolygon(v28, &v21, &v27, &v23, &v24, &v25, v1103, v1111,
                                                    v1125, v1136, v1147, &v1119);
                                    v31 = (unsigned __int8)x_BYTE_E126D;
                                }
                                goto LABEL_53;
                            }
                        ...
                        v28 =
                            LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v21, &v22, &v23, &v24,
                                        &v25, v1103, v1107, v1125, v1136, v1147, &v1117);
                        v27 = v1121;
                        goto LABEL_51;
                    }
                }
 ...
 LABEL_234:
            ...
            case 0x11:
                ...
                LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v134, &v135, &v136, v1105, v1109,
                            v1152, &v1115);
                v31 = (unsigned __int8)x_BYTE_E126D;
                goto LABEL_53;
            case 2:
            ...
            case 0x17:
                ...
                LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v128, &v129, &v130, &v131, v1105,
                            v1109, v1130, v1141, &v1115);
                v31 = (unsigned __int8)x_BYTE_E126D;
                goto LABEL_53;
            case 5:
            case 6:
            ...
            case 0x1A:
                ...
                LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v120, &v121, &v122, &v123, &v124,
                            v1105, v1109, v1129, v1140, v1151, &v1115);
                v31 = (unsigned __int8)x_BYTE_E126D;
                goto LABEL_53;
            }
        }
 ...
 LABEL_277:
        ...
        case 0x11:
            ...
            LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v160, &v161, &v162, v1106, v1110, v1154,
                        &v1116);
            v31 = (unsigned __int8)x_BYTE_E126D;
            goto LABEL_53;
        case 2:
        ...
        case 0x17:
            ...
            LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v154, &v155, &v156, &v157, v1106, v1110,
                        v1132, v1143, &v1116);
            v31 = (unsigned __int8)x_BYTE_E126D;
            goto LABEL_53;
        case 5:
        ...
        case 0x1A:
            ...
            LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v146, &v147, &v148, &v149, &v150, v1106,
                        v1110, v1131, v1142, v1153, &v1116);
            v31 = (unsigned __int8)x_BYTE_E126D;
            goto LABEL_53;
        }
    }
 ...
 LABEL_129:
    ...
    if (((v4->X - v3->X) << 16) / v68 > v1104) {
        ...
        case 0xF:
            ...
            v114 =
                LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v110, &v111, v1104, v1108, &v1114);
            v113 = v1122;
 LABEL_228:
            if (v1297) {
                v31 = (unsigned __int8)x_BYTE_E126D;
        ...
        case 0x11:
            ...
            if (!v100)
                v1146 =
                    (signed int)(v3->Brightness +
                                 (unsigned __int64)(v1114 *
                                                    (signed __int64)(v4->Brightness -
                                                                     v3->Brightness) / v1118) -
                                 v5->Brightness)
                    / (v101 + 1);
 ...
 LABEL_206:
                ...
                v108 = viewPort.Height_DE568 - v1191;
                triLn_v1123 = viewPort.Height_DE568 - v1191;
                if (v1297) {
                    v1114 = viewPort.Height_DE568 - v1191;
                } else {
            ...
            v107 =
                LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v102, &v103, &v104, v1104, v1108,
                            v1150, &v1114);
            v106 = v1122;
            goto LABEL_206;
        case 2:
        ...
        case 0x17:
            ...
            if (!v86) {
                ...
                v1124 =
                    (signed int)(v3->U +
                                 (unsigned __int64)(v1114 * (signed __int64)(v4->U - v3->U) /
                                                    v1118) - v5->U)
                    / v88;
                v1135 =
                    (signed int)(v3->V +
                                 (unsigned __int64)(v1114 * (signed __int64)(v4->V - v3->V) /
                                                    v1118) - v5->V)
                    / v88;
            }
 ...
 LABEL_181:
                    if (v1297) {
                        ...
                        v95 =
                            LoadPolygon(v95, &v94, &v90, &v91, &v92, v1112, v1108, v1134, v1145,
                                        &v1120);
                        v31 = (unsigned __int8)x_BYTE_E126D;
                    }
                    goto LABEL_53;
            ...
            v95 =
                LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v89, &v90, &v91, &v92, v1104, v1108,
                            v1128, v1139, &v1114);
            v94 = v1122;
            goto LABEL_181;
        case 5:
 ...
 LABEL_156:
                    if (v1297) {
                        ...
                        v81 =
                            LoadPolygon(v81, &v80, &v75, &v76, &v77, &v78, v1112, v1108, v1133,
                                        v1144, v1155, &v1120);
                        v31 = (unsigned __int8)x_BYTE_E126D;
                    }
 LABEL_53:
                        ...
                        while (1) {
                            ...
                            if (line2 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v176 > 0) {
                                    ...
                                    if (v176 > viewPort.Width_DE564)
                                        LOWORD(v176) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line3 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v230 > 0) {
                                    ...
                                    if (v230 > viewPort.Width_DE564)
                                        LOWORD(v230) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line4 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v286 > 0) {
                                    ...
                                    if (v286 > viewPort.Width_DE564)
                                        LOWORD(v286) = viewPort.Width_DE564;
 ...
 LABEL_509:
                                            ...
                                            LOWORD(v384) = v384 - 16;
                                            if ((unsigned __int8)(((v384 & 0x8000u) != 0) ^ v18) |
                                                ((x_WORD) v384 == 0))
                                                break;
 LABEL_494:
                                            v180 = __CFADD__((x_WORD) v1124, (x_WORD) v383);
 ...
 LABEL_568:
                                            ...
                                            LOWORD(v399) = v399 - 16;
                                            if ((unsigned __int8)(((v399 & 0x8000u) != 0) ^ v18) |
                                                ((x_WORD) v399 == 0))
                                                break;
 LABEL_523:
                                            LOBYTE(v390) = *(x_BYTE *) (v391 + v404);
 ...
 LABEL_571:
                        ...
                        if (v393 > viewPort.Width_DE564)
                            LOWORD(v393) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line9 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v448 > 0) {
                                    ...
                                    if (v448 > viewPort.Width_DE564)
                                        LOWORD(v448) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line10 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v488 > 0) {
                                    ...
                                    if (v488 > viewPort.Width_DE564)
                                        LOWORD(v488) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line11 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v528 > 0) {
                                    ...
                                    if (v528 > viewPort.Width_DE564)
                                        LOWORD(v528) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line12 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v568 > 0) {
                                    ...
                                    if (v568 > viewPort.Width_DE564)
                                        LOWORD(v568) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line18 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v764 > 0) {
                                    ...
                                    if (v764 > viewPort.Width_DE564)
                                        LOWORD(v764) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line21 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v886 > 0) {
                                    ...
                                    if (v886 > viewPort.Width_DE564)
                                        LOWORD(v886) = viewPort.Width_DE564;
                        ...
                        while (1) {
                            ...
                            if (line22 >= drawEveryNthLine) {
                                ...
                                if ((signed __int16)v926 > 0) {
                                    ...
                                    if (v926 > viewPort.Width_DE564)
                                        LOWORD(v926) = viewPort.Width_DE564;
 ...
 LABEL_1282:
                        ...
                        if ((unsigned __int8)(((v1007 & 0x8000u) != 0) ^ v18) |
                            ((x_WORD) v1007 == 0))
                            goto LABEL_1282;
                        v1008 += v1005;
 ...
 LABEL_1361:
            ...
            v81 =
                LoadPolygon((x_DWORD *) unk_DE56Cx[startLine], &v74, &v75, &v76, &v77, &v78, v1104,
                            v1108, v1127, v1138, v1149, &v1114);
            v80 = v1122;
            goto LABEL_156;
        }
    }
...
x_DWORD *GameRenderHD::LoadPolygon(x_DWORD *ptrPolys, int *v0, int *v1, int *v4, int s0, int s1,
                                   int s4, int *line)
{
    do {
        ptrPolys[0] = *v0;
...
x_DWORD *GameRenderHD::LoadPolygon(x_DWORD *ptrPolys, int *v0, int *v1, int *v2, int *v3, int s0,
                                   int s1, int s2, int s3, int *line)
{
    do {
        ptrPolys[0] = *v0;
        *v0 += s0;
...
x_DWORD *GameRenderHD::LoadPolygon(x_DWORD *ptrPolys, int *v0, int *v1, int *v2, int *v3, int *v4,
                                   int s0, int s1, int s2, int s3, int s4, int *line)
{
    do {
        ptrPolys[0] = *v0;
        *v0 += s0;
