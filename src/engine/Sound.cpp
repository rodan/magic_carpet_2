    ...
    if (soundIndex_E37A0 && soundBuffer1_E37A8) {
        for (index = 0; index < count; index++) {
            ...
            soundIndex_E37A0->str_8.wavs_10[index].wavData_0 =
                reinterpret_cast < uint32_t > (soundIndex_E37A0->str_8.wavs_10[index].wavData_0) + soundBuffer1_E37A8;
#endif                          //x32_BIT_ENVIRONMENT
#ifdef x64_BIT_ENVIRONMENT
            soundIndex_E37A0->str_8.wavs_10[index].wavData_0 =
                reinterpret_cast < uint64_t > (soundIndex_E37A0->str_8.wavs_10[index].wavData_0) + soundBuffer1_E37A8;
...
bool ReadAndDecompressSound(FILE *file, uint8_t soundIndex2)    //2654f0
{
    ...
    //64xfix
    shadow_str_E37A0_sound_buffer2 = (shadow_type_E37A0_sound_buffer2 *) calloc(1, sizeof(shadow_type_E37A0_sound_buffer2));
    ...
    if (soundBuffer1_E37A8[0] != 'R' || soundBuffer1_E37A8[1] != 'N' || soundBuffer1_E37A8[2] != 'C') {
        ...
        DataFileIO::Read(file, (soundBuffer1_E37A8 + 8),
                         ...
                         ((soundBuffer1_E37A8[6] + ((soundBuffer1_E37A8[5] + (soundBuffer1_E37A8[4] << 8)) << 8)) << 8) - 8);
    ...
    if (shadow_str_E37A0_sound_buffer2->byte_0 != 'R'
        || shadow_str_E37A0_sound_buffer2->byte_1 != 'N' || shadow_str_E37A0_sound_buffer2->byte_2 != 'C') {
        ...
        DataFileIO::Read(file, (uint8_t *) & shadow_str_E37A0_sound_buffer2->str_8,
                         ...
                         ((shadow_str_E37A0_sound_buffer2->byte_6 +
                           ((shadow_str_E37A0_sound_buffer2->byte_5 + (shadow_str_E37A0_sound_buffer2->byte_4 << 8)) << 8)) << 8) - 8);
    ...
    for (int i = 0; i < numOfLoadedSounds_E37A4; i++) {
        ...
        memcpy(soundIndex_E37A0->str_8.wavs_10[i].filename_14, shadow_str_E37A0_sound_buffer2->str_8.wavs_10[i].filename_14, 18);
...
int sub_9EE70()
{
    if (!sampleFinished_E3E45 && AilSampleUserData_95480(mainSample_181E10, x_DWORD_E3E40)
        ...
        AilSetSampleFile_938C0(mainSample_181E10,
                               soundIndex_E37A0->str_8.wavs_10[AilSampleUserData_95480(mainSample_181E10, x_DWORD_E3E40)].wavData_0, 1);
        x_DWORD_E3E40++;
...
__int64 sub_9F3D0(HMDIDRIVER hMdiDriver, int /*a2 */ , unsigned __int16 a3, unsigned __int16 a4)
{
    ...
    if (str_E3E54.par1 || str_E3E54.par2 || (v4 = sub_9F110(4), str_E3E54.par2 = WORD2(v4), (str_E3E54.par1 = v4) != 0)) {
                    ...
                    if (sub_9F2E0(hMdiMusicDriver, v5x.par1, v5x.par2, 2u).AX == -1     //fix
                        ...
                        if ((x_DWORD) v2 || v5x.par2) {
                            ...
                            if ((x_DWORD) v3 || x_WORD_181E2A) {
                                ...
                                if (!dos_read(file, x_DWORD_181E26, (unsigned __int16)x_WORD_181E2A, __readgsx_DWORD(v5x.par1 + 10), &v8)
...
void InitSampleVolume_A2110(HSAMPLE S)  //283110
{
    ...
    if (S->format_13 != 1 && S->format_13 != 3) {       //set volume table
        if (volumeA)
            volumeA++;
        if (S->sam_var[6] != 2 && S->sam_var[6] != 3 && (S->sam_var[6] && S->sam_var[6] != 1 || S->format_13 != 2 && S->format_13 != 3)) {
            index1 = 0;
            if (S->flags_14 & 1) {
            ...
            if (ioInitited) {
                ...
                if (sub_A2650(digDriver)) {
                    ...
                    digDriver->samples_per_buffer_18 =
                        digDriver->half_buffer_size_4 / (digDriver->bytes_per_channel_16 * digDriver->channels_per_sample_15);
                    ...
                    if (digDriver->build_buffer_20) {
                        ...
                        digDriver->samples_23 = (_SAMPLE *) calloc(digDriver->n_samples_24, sizeof(_SAMPLE));
    ...
    if (a3 < 0x6F) {
        ...
        if (a3 <= 0x6C) {       //6c
            if (hSequence->prefix_callback_7)
                hSequence->shadow_53.indirect[indexCh] = (*(int (**)(HSEQUENCE, int, signed int))(hSequence->prefix_callback_7))
 ...
 LABEL_79:                     //end
            if (mdiDriver->lock[chMap] != 1 || mdiDriver->locker[chMap] == hSequence) {
                ...
                if (indexChH != 144 || hSequence->shadow_53.c_mute[indexCh] < 64) {
                    if (!mdiDriver->event_trap || ((HMDIDRIVER) (x_DWORD *)
                                                   ((int (*)(HMDIDRIVER, HSEQUENCE, int, unsigned int, signed int))
                                                    mdiDriver->event_trap) (mdiDriver, hSequence, chMap | indexChH, a3, (int)a4)) == 0) {
...
__int16 sub_98B2C(unsigned __int8 a1, int a2)   //180804 279b2c
{
    ...
    v5 = x_BYTE_E3B51 - v2;
    if (x_BYTE_E3B51 < v2) {
        v4 = __ROR2__(x_WORD_E3B4E & ((1 << x_BYTE_E3B51) - 1), x_BYTE_E3B51) | ((unsigned __int16)x_WORD_E3B4C >> x_BYTE_E3B51);
        v3 = *(x_WORD *) (a2 + 2);
        v2 -= x_BYTE_E3B51;
        v5 = 16 - v2;
    }
    ...
    if (musicHeader_E3808 && musicData_E3810) {
        for (m_iNumberOfTracks = 0; m_iNumberOfTracks < countOfMusicTracks_E380C; m_iNumberOfTracks++) {
            ...
            musicHeader_E3808->str_8.track_10[m_iNumberOfTracks].xmiData_0 =
                &musicData_E3810[musicHeader_E3808->str_8.track_10[m_iNumberOfTracks].xmiData_0 - zero_pointer];
        }
    }
}
    ...
    case 2:
        {
            ...
            for (int j = 0; j < x_DWORD_180B4C_end_sound_buffer3_endindex; j++) {
                if (SoundBuffer3_180750[j]->flags_14 == flags
                    && SoundBuffer3_180750[j]->vol_scale_18[0][0] == index && AilSampleStatus_94010(SoundBuffer3_180750[j]) != 2) {
    ...
    if (soundAble_E3798 && soundActive_E3799) {
        for (int i = 0; i < x_DWORD_180B4C_end_sound_buffer3_endindex; i++) {
            if (SoundBuffer3_180750[i]->flags_14 == a1
                && SoundBuffer3_180750[i]->vol_scale_18[0][0] == a2 && AilSampleStatus_94010(SoundBuffer3_180750[i]) != 2) {
    ...
    if (soundAble_E3798 && soundActive_E3799 && index <= indexLoadedSound_180B50) {
        for (int i = 0; i < x_DWORD_180B4C_end_sound_buffer3_endindex; i++) {
            if (SoundBuffer3_180750[i]->flags_14 == flags
                && SoundBuffer3_180750[i]->vol_scale_18[0][0] == index && AilSampleStatus_94010(SoundBuffer3_180750[i]) != 2) {
                if (loopCount > 127)
                    loopCount = 127;
...
void sub_99970(char a1, unsigned __int8 a2)     //27a970
{
    if (pcSpeakerSoundDev_E3819 && musicAble_E37FC && musicActive_E37FD
        && songCurrentlyPlaying_E3802 && AilSequenceStatus_96170(m_hSequence) != 2 && x_BYTE_E3817 != a1) {
        if (x_BYTE_E3818) ;     // sub_92DC0_AIL_release_timer_handle(x_DWORD_180C80);
        x_BYTE_E3817 = a1;
