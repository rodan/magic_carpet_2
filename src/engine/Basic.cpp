...
filearray_struct x_DWORD_E9B20[4] =
    { filearray_2aa18c[filearrayindex_FONTS0DATTAB], filearray_2aa18c[filearrayindex_MSPRDDATTAB],
    filearray_2aa18c[filearrayindex_HFONT3DATTAB], filearray_2aa18c[filearrayindex_MSPRDDATTAB]
};

type_SPELLS_BEGIN_BUFFER_str SPELLS_BEGIN_BUFFER_str[26] = { {0x03, 0x00, {
                                                                           {0x000000FA, 0x00000064,
                                                                            0x00000000, 0x00000000,
                                                                            0x00000000, 0x00BA,
                                                                            0x0005, 0x00, 0x00},
                                                                           {0x000000A0, 0x000000FA,
                                                                            0x00000000, 0x00000190,
                                                                            0x00000096, 0x00BB,
                                                                            0x000B, 0x01, 0x01},
                                                                           {0x00000050, 0x000005DC,
                                                                            0x000009C4, 0x00001388,
                                                                            0x000002EE, 0x00BC,
                                                                            0x000F, 0x02, 0x00}}},
{0x03, 0x00, {
              {0x0000000A, 0x00000064, 0x00000000, 0x00000000, 0x00000000, 0x00BD, 0x0003, 0x00,
               0x00},
              {0x0000000F, 0x000000FA, 0x00000000, 0x0000012C, 0x00000032, 0x00BE, 0x0029, 0x01,
               0x00},
              {0x00000014, 0x000003E8, 0x000003E8, 0x00000384, 0x00000096, 0x00BF, 0x0033, 0x02,
               0x00}}},
{0x03, 0x00, {
              {0x00000000, 0x000003E8, 0x00000000, 0x00000000, 0x00000000, 0x00C0, 0x0065, 0x00,
               0x00},
              {0x00000000, 0x000004E2, 0x00000000, 0x00000019, 0x00000004, 0x00C1, 0x0065, 0x01,
               0x00},
              {0x00000001, 0x000007D0, 0x00000000, 0x0000007D, 0x00000006, 0x00C2, 0x0065, 0x02,
               0x00}}},
{0x03, 0x04, {
              {0x00000002, 0x000003E8, 0x00000000, 0x00000000, 0x00000000, 0x00C3, 0x012D, 0x00,
               0x00},
              {0x00000003, 0x000009C4, 0x00000000, 0x0000008C, 0x0000000F, 0x00C4, 0x01C3, 0x00,
               0x00},
              {0x00000004, 0x00001388, 0x00000000, 0x00000118, 0x0000002D, 0x00C5, 0x01F5, 0x00,
               0x00}}},
{0x03, 0x04, {
              {0x00000064, 0x00001388, 0x00004E20, 0x00000000, 0x00000000, 0x00C6, 0x00C9, 0x13,
               0x00},
              {0x00000064, 0x00001D4C, 0x00004E20, 0x00000050, 0x00000014, 0x00C8, 0x012D, 0x19,
               0x00},
              {0x00000064, 0x00003A98, 0x000061A8, 0x000000F0, 0x0000003C, 0x00C9, 0x01C7, 0x10,
               0x00}}},
{0x03, 0x00, {
              {0x00000001, 0x000001F4, 0x00000000, 0x00000000, 0x00000000, 0x00CA, 0x000B, 0x00,
               0x00},
              {0x00000001, 0x000002EE, 0x00000000, 0x0000012C, 0x0000004B, 0x00CB, 0x0015, 0x00,
               0x00},
              {0x0000000A, 0x000005DC, 0x00000000, 0x00000384, 0x0000012C, 0x00CC, 0x0029, 0x00,
               0x00}}},
{0x03, 0x04, {
              {0x00000064, 0x000003E8, 0x00000000, 0x00000000, 0x00000000, 0x00CD, 0x0065, 0x00,
               0x00},
              {0x00000064, 0x000005DC, 0x00000000, 0x00000078, 0x0000001E, 0x00CE, 0x00C9, 0x00,
               0x00},
              {0x00000064, 0x00002710, 0x00000000, 0x00000118, 0x00000046, 0x00CF, 0x012D, 0x01,
               0x00}}},
{0x03, 0x00, {
              {0x000000C8, 0x000001F4, 0x000002EE, 0x00000000, 0x00000000, 0x00D0, 0x0005, 0x00,
               0x01},
              {0x000000FA, 0x000009C4, 0x00001388, 0x00000258, 0x00000096, 0x00D1, 0x0023, 0x01,
               0x00},
              {0x00000320, 0x00002710, 0x00004E20, 0x00001D4C, 0x000001F4, 0x00D2, 0x002D, 0x02,
               0x00}}},
{0x03, 0x04, {
              {0x00000000, 0x000009C4, 0x00001388, 0x00000000, 0x00000000, 0x00D3, 0x007D, 0x00,
               0x00},
              {0x00000000, 0x00000EA6, 0x00001D4C, 0x00000078, 0x0000001E, 0x00D4, 0x00FB, 0x00,
               0x00},
              {0x00000000, 0x00001B58, 0x00002710, 0x000000F0, 0x0000003C, 0x00D5, 0x007D, 0x01,
               0x00}}},
{0x03, 0x00, {
              {0x000006D6, 0x000003E8, 0x00001388, 0x00000000, 0x00000000, 0x00D6, 0x0009, 0x02,
               0x00},
              {0x00000DAC, 0x000005DC, 0x00002328, 0x00000352, 0x00000032, 0x00D7, 0x0011, 0x05,
               0x00},
              {0x00001B58, 0x000007D0, 0x00004650, 0x0000092E, 0x00000096, 0x00D8, 0x0019, 0x0A,
               0x00}}},
{0x03, 0x00, {
              {0x00000000, 0x00001388, 0x00001388, 0x00000000, 0x00000000, 0x00D9, 0x000B, 0x00,
               0x00},
              {0x00000000, 0x00001770, 0x00001388, 0x000000C8, 0x0000001E, 0x00DA, 0x000B, 0x01,
               0x00},
              {0x00000000, 0x00001D4C, 0x00001388, 0x00000190, 0x0000005A, 0x00DB, 0x0015, 0x02,
               0x00}}},
{0x03, 0x04, {
              {0x00000000, 0x000007D0, 0x000007D0, 0x00000000, 0x00000000, 0x00DC, 0x00B5, 0x01,
               0x00},
              {0x00000000, 0x000009C4, 0x00000BB8, 0x00000064, 0x0000001E, 0x00DD, 0x00B7, 0x02,
               0x00},
              {0x00000000, 0x00000BB8, 0x00000FA0, 0x0000012C, 0x0000005A, 0x00DE, 0x00B7, 0x03,
               0x00}}},
{0x03, 0x04, {
              {0x00000000, 0x00000708, 0x00000000, 0x00000000, 0x00000000, 0x00DF, 0x0097, 0x00,
               0x00},
              {0x00000000, 0x00000960, 0x00002710, 0x00000078, 0x0000001E, 0x00E0, 0x0105, 0x00,
               0x00},
              {0x00000000, 0x00001388, 0x00002710, 0x00000168, 0x0000003C, 0x00E1, 0x0169, 0x00,
               0x00}}},
{0x03, 0x00, {
              {0x000007D0, 0x000001F4, 0x00002710, 0x00000000, 0x00000000, 0x00E2, 0x0005, 0x00,
               0x00},
              {0x00000FA0, 0x000003E8, 0x00003A98, 0x00000190, 0x00000064, 0x00E3, 0x0007, 0x00,
               0x00},
              {0x0000000A, 0x000004B0, 0x00002EE0, 0x00000320, 0x000000C8, 0x00E4, 0x0015, 0x01,
               0x00}}},
{0x03, 0x04, {
              {0x00001432, 0x000009C4, 0x00002710, 0x00000000, 0x00000000, 0x00E5, 0x00C3, 0x00,
               0x00},
              {0x00001E28, 0x00000DAC, 0x00003A98, 0x00000064, 0x00000032, 0x00E6, 0x018B, 0x01,
               0x00},
              {0x00001E28, 0x00001388, 0x00004E20, 0x000000C8, 0x00000064, 0x00E7, 0x025B, 0x02,
               0x00}}},
{0x03, 0x00, {
              {0x00000014, 0x00001388, 0x00002710, 0x00000000, 0x00000000, 0x00E8, 0x001F, 0x3C,
               0x00},
              {0x00000028, 0x00001D4C, 0x00004E20, 0x000003E8, 0x00000028, 0x00E9, 0x0029, 0x50,
               0x00},
              {0x00000032, 0x00002710, 0x00009C40, 0x000007D0, 0x00000064, 0x00EA, 0x003D, 0x78,
               0x00}}},
{0x03, 0x00, {
              {0x00000032, 0x00001770, 0x00003A98, 0x00000000, 0x00000000, 0x00EB, 0x001F, 0x06,
               0x00},
              {0x00000064, 0x00002328, 0x00007530, 0x000005DC, 0x00000028, 0x00EC, 0x0029, 0x0C,
               0x00},
              {0x0000012C, 0x00002EE0, 0x0000EA60, 0x00000BB8, 0x00000050, 0x00ED, 0x0033, 0x18,
               0x00}}},
{0x03, 0x00, {
              {0x00000050, 0x00002710, 0x00004650, 0x00000000, 0x00000000, 0x00EE, 0x0015, 0x10,
               0x00},
              {0x00000078, 0x00002EE0, 0x00008CA0, 0x00000708, 0x0000003C, 0x00EF, 0x001F, 0x20,
               0x00},
              {0x00000140, 0x00003A98, 0x00011940, 0x00000E10, 0x00000078, 0x00F0, 0x0029, 0x40,
               0x00}}},
{0x03, 0x00, {
              {0x00000078, 0x00002EE0, 0x00004E20, 0x00000000, 0x00000000, 0x00F1, 0x003F, 0x07,
               0x00},
              {0x000000F0, 0x00003A98, 0x00009C40, 0x000007D0, 0x00000028, 0x00F2, 0x0049, 0x09,
               0x00},
              {0x000001E0, 0x00004650, 0x00013880, 0x00000FA0, 0x00000050, 0x00F3, 0x0053, 0x0B,
               0x00}}},
{0x03, 0x00, {
              {0x00000064, 0x00002710, 0x00004E20, 0x00000000, 0x00000000, 0x00F4, 0x012B, 0x13,
               0x00},
              {0x00000064, 0x00004E20, 0x00009C40, 0x00000050, 0x00000028, 0x00F6, 0x018F, 0x19,
               0x00},
              {0x00000064, 0x00009C40, 0x00015F90, 0x000000A0, 0x00000050, 0x00F7, 0x01F3, 0x10,
               0x00}}},
{0x03, 0x00, {
              {0x000002EE, 0x00003A98, 0x00007530, 0x00000000, 0x00000000, 0x00F8, 0x001F, 0x10,
               0x00},
              {0x000005DC, 0x00004E20, 0x0000EA60, 0x000009C4, 0x00000019, 0x00F9, 0x0033, 0x1A,
               0x00},
              {0x00000BB8, 0x00007530, 0x00015F90, 0x00001388, 0x00000032, 0x00FA, 0x003D, 0x28,
               0x00}}},
{0x03, 0x00, {
              {0x00000064, 0x000007D0, 0x00000000, 0x00000000, 0x00000000, 0x00FB, 0x001F, 0x05,
               0x00},
              {0x00000064, 0x000009C4, 0x000009C4, 0x000000C8, 0x00000032, 0x00FC, 0x0033, 0x0A,
               0x00},
              {0x000000C8, 0x00001388, 0x00002710, 0x00000190, 0x00000064, 0x00FD, 0x003D, 0x0A,
               0x00}}},
{0x03, 0x00, {
              {0x000000FA, 0x000003E8, 0x00001388, 0x00000000, 0x00000000, 0x00FE, 0x001F, 0x00,
               0x00},
              {0x000001F4, 0x000005DC, 0x00002710, 0x00000050, 0x0000001E, 0x00FF, 0x001F, 0x01,
               0x00},
              {0x000003E8, 0x000007D0, 0x00002710, 0x000000A0, 0x0000003C, 0x0100, 0x001F, 0x02,
               0x00}}},
{0x03, 0x00, {
              {0x000003E8, 0x00002710, 0x00004E20, 0x00000000, 0x00000000, 0x0101, 0x002F, 0x00,
               0x00},
              {0x00001388, 0x00002EE0, 0x00004E20, 0x00000078, 0x0000001E, 0x0102, 0x0043, 0x01,
               0x00},
              {0x00002710, 0x00005DC0, 0x0000EA60, 0x000000F0, 0x0000003C, 0x0103, 0x0057, 0x02,
               0x00}}},
{0x03, 0x00, {
              {0x00000262, 0x00002710, 0x00004E20, 0x00000000, 0x00000000, 0x0104, 0x002B, 0x10,
               0x00},
              {0x0000044C, 0x00004650, 0x00008CA0, 0x0000005A, 0x0000001E, 0x0105, 0x0021, 0x1A,
               0x00},
              {0x00000A96, 0x00007530, 0x00015F90, 0x00000118, 0x00000046, 0x0106, 0x0021, 0x20,
               0x00}}},
{0x03, 0x00, {
              {0x00000064, 0x00002AF8, 0x00004A38, 0x00000000, 0x00000000, 0x0107, 0x001F, 0x00,
               0x00},
              {0x00000082, 0x000032C8, 0x00009470, 0x000000C8, 0x00000028, 0x0108, 0x0029, 0x01,
               0x00},
              {0x00000186, 0x00006590, 0x0000DAC0, 0x00000190, 0x00000078, 0x0109, 0x0033, 0x02,
               0x00}}}
};
...
Pathstruct xasearchd_2bac30 =
    { "*SearchD\0", (uint8_t **) & SEARCH_BEGIN_BUFFER, &SEARCH_END_BUFFER, 0x1000, 0 };
//#define psxasearchd_2bac30 0
Pathstruct xafonts0dat = { "DATA/FONT0.DAT\0", &FONTS0DAT_BEGIN_BUFFER, NULL, 0, 0 };

//#define psxafonts0dat 1
Pathstruct xafonts0tab =
    { "DATA/FONT0.TAB\0", (uint8_t **) & FONTS0TAB_BEGIN_BUFFER,
(uint8_t **) & FONTS0TAB_END_BUFFER, 0, 0 };
//#define psxafonts0tab 2
Pathstruct xafonts1dat = { "DATA/FONT1.DAT\0", &FONTS1DAT_BEGIN_BUFFER, NULL, 0, 0 };

//#define psxafonts1dat 3
Pathstruct xafonts1tab =
    { "DATA/FONT1.TAB\0", (uint8_t **) & FONTS1TAB_BEGIN_BUFFER,
(uint8_t **) & FONTS1TAB_END_BUFFER, 0, 0 };
//#define psxafonts1tab 4
Pathstruct xadatatmaps00tab =
    { "DATA/TMAPS0-0.TAB", (uint8_t **) & str_TMAPS00TAB_BEGIN_BUFFER, NULL, 0, 0 };
...
Pathstruct xadatapointerstab =
    { "DATA/POINTERS.TAB\0", (uint8_t **) & POINTERSTAB_BEGIN_BUFFER,
(uint8_t **) & POINTERSTAB_END_BUFFER, 0, 0 };
...
Pathstruct xadatabuild00tab =
    { "DATA/BUILD0-0.TAB\0", (uint8_t **) & BUILD00TAB_BEGIN_BUFFER,
(uint8_t **) & BUILD00TAB_END_BUFFER, 0, 0 };
...
//zero
//#define psxazero7 27
Pathstruct xawscreen_351628 =
    { "*WScreen\0", &WSCREEN_BEGIN_BUFFER, &WSCREEN_END_BUFFER, 0x04b100, 0 };
//#define psxawscreen_351628 28
Pathstruct xabscreen2 =
    { "*BScreen\0", &x_DWORD_E9C38_smalltit, &BSCREEN2_END_BUFFER, 0x11170 /*0x011508 */ , 0 };
...
Pathstruct xadatamsprd00tab =
    { "DATA/MSPRD0-0.TAB\0", (uint8_t **) & MSPRD00TAB_BEGIN_BUFFER,
(uint8_t **) & MSPRD00TAB_END_BUFFER, 0, 0 };
...
Pathstruct xadatahsprd00tab =
    { "DATA/HSPRD0-0.TAB\0", (uint8_t **) & HSPRD00TAB_BEGIN_BUFFER,
(uint8_t **) & HSPRD00TAB_END_BUFFER, 0, 0 };
...
Pathstruct xadatahfont3tab =
    { "DATA/HFONT3.TAB\0", (uint8_t **) & HFONT3TAB_BEGIN_BUFFER,
(uint8_t **) & HFONT3TAB_END_BUFFER, 0, 0 };
...
x_DWORD x_outp(x_DWORD, char)
{
    stub_fix_it();
    return 0;
};                              // weak

x_DWORD x_inp(x_DWORD)
{
    stub_fix_it();
    return 0;
};                              // weak
...
void sub_2EBB0_draw_text_with_border_630x340(char *textString)  //20fbb0
{
    if (x_BYTE_D41CE) {
        ...
        /*result = */ sub_7FCB0_draw_text_with_border( /*64, */ textString, 0, 630, 340, 5,
                                                      x_BYTE_EB3B6, 0);
        x_WORD_E36D4 = 0;
        pdwScreenBuffer_351628 -= 0x26C0;
    }
    ...
    if (a6) {
        if (a6 == 2 || a6 == 5) {
            ...
            if (a8) {
                ...
                sub_7C120_draw_bitmap_640(a4 - xy_DWORD_17DED4_spritestr[274].width_4, v8,
                    ...
                    if (a6 && a6 != 4) {
                        if (a6 == 2) {
                            ...
                            for (v32 = 0; v32 < xy_DWORD_17DED4_spritestr[274].height_5; v32++) {
                                for (v33 = 0;
                                     v33 < a4 - (v99 - xy_DWORD_17DED4_spritestr[274].width_4);
                                     v33++) {
                                    HIBYTE(v97) = 15;
                                    LOBYTE(v97) = *v31;
                                    v31++;
                                    *(v31 - 1) =
                                        ((uint8_t *) x_DWORD_17DE38str.x_DWORD_17DE3C)[v97];
                                }
                                v31 += 640 - v33;
                            }
                            ...
                            sub_6FC80_pre_draw_text(v87,
                                                    v99 + xy_DWORD_17DED4_spritestr[275].width_4,
                                                    v36, v35, a7);
                        } else if (a6 == 5) {
                            if (a8) {
                                ...
                                for (v37 = 0; v37 < xy_DWORD_17DED4_spritestr[274].height_5; v37++) {
                                    for (v39 = 0;
                                         v39 < a4 - (xy_DWORD_17DED4_spritestr[274].width_4 + v99);
                                         v39++) {
                                        HIBYTE(v40) = 15;
                                        LOBYTE(v40) = *v38;
                                        v38++;
                                        *(v38 - 1) =
                                            ((uint8_t *) x_DWORD_17DE38str.x_DWORD_17DE3C)[v40];
                                    }
                                    v38 += 640 - v39;
                                }
                                v41 = v99;
                                ...
                                sub_7C120_draw_bitmap_640(a4 -
                                                          xy_DWORD_17DED4_spritestr[274].width_4,
                                                          a1, xy_DWORD_17DED4_spritestr[274]);
    ...
    if (!v95)                   //address 2614e2 (804e2) discoverwhich
    {
        if (a6 && a6 != 4) {
            ...
            if (a6 == 2) {
                ...
                sub_6FC80_pre_draw_text(v87, v99 + xy_DWORD_17DED4_spritestr[275].width_4, v70, v69,
                                        a7);
            } else if (a6 == 5) {
                if (a8) {
                    v71 = 640 * a1 + v99;
                    ...
                    for (l = 0; l < xy_DWORD_17DED4_spritestr[274].height_5; l++) {
                        v72 += v71;
                        v74 = 0;
                        for (v74 = 0; v74 < a4 - (xy_DWORD_17DED4_spritestr[274].width_4 + v99);
                             v74++) {
                            HIBYTE(v97) = 15;
                            LOBYTE(v97) = *v72;
                            v72++;
                    ...
                    sub_7C120_draw_bitmap_640(v99, a1, xy_DWORD_17DED4_spritestr[274]);
                    v86 = *xy_DWORD_17DED4_spritestr[274].data;
                    sub_7C120_draw_bitmap_640(a4 - xy_DWORD_17DED4_spritestr[274].width_4, a1,
                                              xy_DWORD_17DED4_spritestr[274]);
                    ...
                    for (v79 = 0; v79 < xy_DWORD_17DED4_spritestr[274].height_5; v79++) {
                        v80 = 0;
                        for (v80 = 0; v80 < a4 - (xy_DWORD_17DED4_spritestr[274].width_4 + v99);
                             v80++) {
                            HIBYTE(v97) = 15;
                            LOBYTE(v97) = *v78;
                            v78++;
                    ...
                    v86 = *xy_DWORD_17DED4_spritestr[274].data;
                    sub_7C120_draw_bitmap_640(a4 - xy_DWORD_17DED4_spritestr[274].width_4, v77,
                                              xy_DWORD_17DED4_spritestr[274]);
                    ...
                    sub_7FAE0_draw_text(v87, v99 + xy_DWORD_17DED4_spritestr[275].width_4, a4, v98,
                                        0);
                } else {
                    sub_7FAE0_draw_text(v87, v99, a4, v98, v86);
                }
...
uint8_t getPaletteIndex_5BE80(TColor *Palettex, uint8_t red_color, uint8_t green_color, uint8_t blue_color)     //23ce80
{
    ...
    for (uint16_t i = 0; i < count_of_colors; i++) {
        newPalAmbient =
            (red_color - Palettex[Palette_index].red) * (red_color - Palettex[Palette_index].red) +
            (green_color - Palettex[Palette_index].green) * (green_color -
                                                             Palettex[Palette_index].green) +
            (blue_color - Palettex[Palette_index].blue) * (blue_color -
                                                           Palettex[Palette_index].blue);
...
void VGA_DrawPlayerCoordData(int x, int y)
{
    if (x_DWORD_EA3E4 != nullptr
        ...
        std::string playerCoordStr = "X: " + std::to_string(axisData.x) +
            " Y: " + std::to_string(axisData.y) + " Z: " + std::to_string(axisData.z);
        ...
        std::string playerRotationStr = "Pitch: " + std::to_string(rotData.pitch) +
            " Roll: " + std::to_string(rotData.roll) + " Yaw: " + std::to_string(rotData.yaw);

        VGA_Draw_stringXYtoBuffer(playerRotationStr.c_str(), x, y + 8, pdwScreenBuffer_351628, 'S');
#endif
#if 0
        axis_2d mouseData = x_WORD_E3760_mouse;
        std::string mouseCoordStr =
            "x: " + std::to_string(mouseData.x) + " y: " + std::to_string(mouseData.y);
...
void LockFps(uint8_t maxFps)
{
    ...
    std::chrono::duration < double, std::milli > renderTimeMS =
        std::chrono::system_clock::now() - m_frameStart;
...
void sub_7FB90_draw_text(char *textbuffer, int16_t posx, int16_t posy, uint8_t color)   //260b90
{
    ...
    while (temptextbuffer[0] && tempposx < 640) {
        ...
        if (v7 < 0xAu)          //formating char
        {
            ...
            {
                if (color)
                    sub_72C40_draw_bitmap_640_setcolor(tempposx, tempposy,
                                                       xy_DWORD_17DEC0_spritestr[temptextbuffer[0]],
                                                       color);
                else
                    sub_7C120_draw_bitmap_640(tempposx, tempposy,
                                              xy_DWORD_17DEC0_spritestr[temptextbuffer[0]]);
            }
            v8 = xy_DWORD_17DEC0_spritestr[65].width_4;
            tempposx += v8;
...
//----- (00090164) --------------------------------------------------------
void DrawLineLowRes_90164(int16_t posStartX, int16_t posStartY, int16_t posEndX, int16_t posEndY,
                          uint8_t colorIdx)
{
    uint8_t *pixel;             // edi
    uint16_t v6;                // dx
...
void sub_8C635_draw_cursor()    //26d635
{
    ...
    x_DWORD_180704_mouse_byte_index1 =
        x_DWORD_1806F8_mousex + x_DWORD_1806F8_mousey * screenWidth_18062C;
...
void sub_8F935_bitmap_draw_final(uint8_t a1byte1, uint8_t a1byte2, uint16_t tiley, int tilex, uint8_t *texture, uint8_t setbyte, char a6)       //270935
{
    ...
    if (!(a1byte2))             //453558
        return;
    pixel_buffer_index =
        pdwScreenBuffer_351628 + x_DWORD_18063C_sprite_sizex +
        screenWidth_18062C * x_DWORD_180650_positiony;
    ...
    if (tilex >= 0) {
        if (tilex + a1byte1 >= x_DWORD_180648_map_resolution2_x) {
                ...
                if (x_WORD_E36D4 & 1) {
                    if (x_WORD_E36D4 & 2) {
                        if (x_DWORD_180634_screen_width - tilex >= 0) {
                            v79 = a1byte1 + tilex;
                            v80 =
                                (x_BYTE *) (screenWidth_18062C * (a1byte2 + tiley) + v79 +
                                            pixel_buffer_index);
                            v81 = 0;
                    ...
                    v91 =
                        (x_BYTE *) (screenWidth_18062C * (a1byte2 + tiley) + tilex +
                                    pixel_buffer_index);
                    v92 = 0;
            ...
            if (x_WORD_E36D4 & 2) {
                v7 = (x_BYTE *) (screenWidth_18062C * (a1byte2 + tiley) + a1byte1 + tilex +
                                 pixel_buffer_index);
                v8 = 0;
                v9 = -1;
                v10 = v7;
                ...
                v14 =
                    (x_BYTE *) (screenWidth_18062C * tiley + a1byte1 + tilex + pixel_buffer_index);
                v15 = 0;
                v16 = -1;
                v17 = v14;
                do {
 ...
 LABEL_225:
    ...
    if (x_WORD_E36D4 & 2) {
        v105 =
            (x_BYTE *) (screenWidth_18062C * (a1byte2 + tiley) + a1byte1 + tilex +
                        pixel_buffer_index);
        v106 = 0;
...
void sub_98709_create_index_dattab_power_add(uint8_t *tabbuffer, uint8_t *tabbufferend, uint8_t *datbuffer, posistruct_t *dattabindex, int add) //279709
{
    for (uint32_t i = 0; i < (tabbufferend - (tabbuffer + add)) / 6; i++) {
        ...
        dattabindex[i].data =
            (uint8_t *) (*(uint32_t *) ((tabbuffer + add) + 6 * i)) + reinterpret_cast < int32_t >
            (datbuffer);
#endif                          //x32_BIT_ENVIRONMENT
#ifdef x64_BIT_ENVIRONMENT
        dattabindex[i].data =
            (uint8_t *) (*(uint32_t *) ((tabbuffer + add) + 6 * i)) + (int32_t) reinterpret_cast <
            int64_t > (datbuffer);
                                         ...
                                         type_D41A0_BYTESTR_0 *to)
{
    ...
    for (int i = 0; i < 0x1a8; i++)
        to->stub3b[i] = from->stub3b[i];
    for (int i = 0; i < 8; i++)
        to->array_0x2362[i] = from->array_0x2362[i];
    for (int i = 0; i < 0x14d; i++)
        to->stub3c[i] = from->stub3c[i];
    for (int i = 0; i < 0x6ff; i++)
        to->stub3d[i] = from->stub3d[i];
    for (int i = 0; i < 8; i++)
        to->array_0x2BDE[i] = from->array_0x2BDE[i];
    for (int i = 0; i < 8; i++)
        to->array_0x6E3E[i] = from->array_0x6E3E[i];
    for (int i = 0; i < 0x3e8; i++) {
        ...
        to->struct_0x6E8E[i].dword_0xA0_160x =
            (type_str_160 *) from->struct_0x6E8E[i].dword_0xA0_160x;
        to->struct_0x6E8E[i].dword_0xA4_164x =
            (type_str_164 *) from->struct_0x6E8E[i].dword_0xA4_164x;
    }
    ...
    to->terrain_2FECE.MapType =
        (from->str_2FECE.MapType == 2) ? MapType_t::Cave : (from->str_2FECE.MapType ==
                                                            1) ? MapType_t::Night : MapType_t::Day;
    to->terrain_2FECE.word_0x2FED5 = from->str_2FECE.word_0x2FED5;
    to->terrain_2FECE.word_0x2FED7 = from->str_2FECE.word_0x2FED7;
    for (int i = 0; i < 8; i++)
        to->terrain_2FECE.player_0x2FED9[i] = from->str_2FECE.array_0x2FED9[i];
    for (int i = 0; i < 4; i++)
        to->terrain_2FECE.stubb[i] = from->str_2FECE.stubb[i];
    to->terrain_2FECE.seed_0x2FEE5 = from->str_2FECE.word_0x2FEE5;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubb2[i] = from->str_2FECE.stubb2[i];
    to->terrain_2FECE.offset_0x2FEE9 = from->str_2FECE.word_0x2FEE9;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubc[i] = from->str_2FECE.stubc[i];
    to->terrain_2FECE.raise_0x2FEED = from->str_2FECE.word_0x2FEED;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubc2[i] = from->str_2FECE.stubc2[i];
    to->terrain_2FECE.gnarl_0x2FEF1 = from->str_2FECE.word_0x2FEF1;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubc3[i] = from->str_2FECE.stubc3[i];
    to->terrain_2FECE.river_0x2FEF5 = from->str_2FECE.word_0x2FEF5;
    to->terrain_2FECE.lriver_0x2FEF9 = from->str_2FECE.word_0x2FEF9;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stube[i] = from->str_2FECE.stube[i];
    to->terrain_2FECE.source_0x2FEFD = from->str_2FECE.word_0x2FEFD;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubf[i] = from->str_2FECE.stubf[i];
    to->terrain_2FECE.snLin_0x2FF01 = from->str_2FECE.word_0x2FF01;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubg[i] = from->str_2FECE.stubg[i];
    to->terrain_2FECE.snFlt_0x2FF05 = from->str_2FECE.word_0x2FF05;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubh[i] = from->str_2FECE.stubh[i];
    to->terrain_2FECE.bhLin_0x2FF09 = from->str_2FECE.word_0x2FF09;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubi[i] = from->str_2FECE.stubi[i];
    to->terrain_2FECE.bhFlt_0x2FF0D = from->str_2FECE.word_0x2FF0D;
    for (int i = 0; i < 2; i++)
        to->terrain_2FECE.stubj[i] = from->str_2FECE.stubj[i];
    to->terrain_2FECE.rkSte_0x2FF11 = from->str_2FECE.word_0x2FF11;
    for (int i = 0; i < 1022; i++)
        to->terrain_2FECE.stubk[i] = from->str_2FECE.stubk[i];
    for (int i = 0; i < 1200; i++)
        to->terrain_2FECE.entity_0x30311[i] = from->str_2FECE.array_0x30311[i];
    to->terrain_2FECE.next_0x360D1 = from->str_2FECE.next_0x360D1;
    for (int i = 0; i < 8; i++)
        to->terrain_2FECE.next_0x360D2[i] = from->str_2FECE.next_0x360D2[i];
    for (int i = 0; i < 8; i++)
        to->terrain_2FECE.stages_0x36442[i] = from->str_2FECE.str_0x36442[i];
    for (int i = 0; i < 11; i++) {
        to->terrain_2FECE.StageVars_0x3647A[i].index_0x3647A_0 =
            from->str_2FECE.array_0x3647A[i].str_0x3647A_byte_0;
        to->terrain_2FECE.StageVars_0x3647A[i].stage_0x3647A_1 =
            from->str_2FECE.array_0x3647A[i].str_0x3647A_byte_1;
        to->terrain_2FECE.StageVars_0x3647A[i].str_0x3647A_2 =
            from->str_2FECE.array_0x3647A[i].str_0x3647A_2;
        to->terrain_2FECE.StageVars_0x3647A[i].str_0x3647C_4.axis =
            from->str_2FECE.array_0x3647A[i].str_0x3647C_4.axis;
    }
    ...
    for (int i = 0; i < 8; i++)
        to->struct_0x3659C[i] = from->struct_0x3659C[i];
    for (int i = 0; i < 11; i++) {
    ...
    for (int i = 0; i < 6; i++)
        to->stub3k[i] = from->stub3k[i];
    to->byte_0x36E0B = from->byte_0x36E0B;
    for (int i = 0; i < 11; i++)
        to->stubend[i] = from->stubend[i];
}
...
void Convert_to_shadow_D41A0_BYTESTR_0(type_D41A0_BYTESTR_0 *from, type_shadow_D41A0_BYTESTR_0 *to)
{
    ...
    to->dword_0x242 = from->dword_0x242;
    for (int i = 0; i < 0x3e8; i++)
        to->pointers_0x246[i] = ((uint8_t *) from->pointers_0x246[i] - Zero_pointer);
    to->dword_0x11e6 = from->dword_0x11e6;
    for (int i = 0; i < 0x3e8; i++)
        to->dword_0x11EA[i] = ((uint8_t *) from->dword_0x11EA[i] - Zero_pointer);
    to->m_GameSettings = from->m_GameSettings;
    to->dword_0x219A = from->dword_0x219A;
    to->dword_0x219E = from->dword_0x219E;
    to->dword_0x21A2 = from->dword_0x21A2;
    ...
    for (int i = 0; i < 0x3e8; i++) {
        ...
        to->struct_0x6E8E[i].word_0x9A_154x = from->struct_0x6E8E[i].word_0x9A_154x;
        to->struct_0x6E8E[i].dword_0xA0_160x =
            ((uint8_t *) from->struct_0x6E8E[i].dword_0xA0_160x - Zero_pointer);
        to->struct_0x6E8E[i].dword_0xA4_164x =
            ((uint8_t *) from->struct_0x6E8E[i].dword_0xA4_164x - Zero_pointer);
    }
    ...
    to->str_2FECE.MapType =
        static_cast < std::underlying_type < MapType_t >::type > (from->terrain_2FECE.MapType);
    to->str_2FECE.word_0x2FED5 = from->terrain_2FECE.word_0x2FED5;
    to->str_2FECE.word_0x2FED7 = from->terrain_2FECE.word_0x2FED7;
    for (int i = 0; i < 8; i++)
        to->str_2FECE.array_0x2FED9[i] = from->terrain_2FECE.player_0x2FED9[i];
    for (int i = 0; i < 4; i++)
        to->str_2FECE.stubb[i] = from->terrain_2FECE.stubb[i];
    to->str_2FECE.word_0x2FEE5 = from->terrain_2FECE.seed_0x2FEE5;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubb2[i] = from->terrain_2FECE.stubb2[i];
    to->str_2FECE.word_0x2FEE9 = from->terrain_2FECE.offset_0x2FEE9;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubc[i] = from->terrain_2FECE.stubc[i];
    to->str_2FECE.word_0x2FEED = from->terrain_2FECE.raise_0x2FEED;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubc2[i] = from->terrain_2FECE.stubc2[i];
    to->str_2FECE.word_0x2FEF1 = from->terrain_2FECE.gnarl_0x2FEF1;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubc3[i] = from->terrain_2FECE.stubc3[i];
    to->str_2FECE.word_0x2FEF5 = from->terrain_2FECE.river_0x2FEF5;
    to->str_2FECE.word_0x2FEF9 = from->terrain_2FECE.lriver_0x2FEF9;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stube[i] = from->terrain_2FECE.stube[i];
    to->str_2FECE.word_0x2FEFD = from->terrain_2FECE.source_0x2FEFD;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubf[i] = from->terrain_2FECE.stubf[i];
    to->str_2FECE.word_0x2FF01 = from->terrain_2FECE.snLin_0x2FF01;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubg[i] = from->terrain_2FECE.stubg[i];
    to->str_2FECE.word_0x2FF05 = from->terrain_2FECE.snFlt_0x2FF05;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubh[i] = from->terrain_2FECE.stubh[i];
    to->str_2FECE.word_0x2FF09 = from->terrain_2FECE.bhLin_0x2FF09;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubi[i] = from->terrain_2FECE.stubi[i];
    to->str_2FECE.word_0x2FF0D = from->terrain_2FECE.bhFlt_0x2FF0D;
    for (int i = 0; i < 2; i++)
        to->str_2FECE.stubj[i] = from->terrain_2FECE.stubj[i];
    to->str_2FECE.word_0x2FF11 = from->terrain_2FECE.rkSte_0x2FF11;
    for (int i = 0; i < 1022; i++)
        to->str_2FECE.stubk[i] = from->terrain_2FECE.stubk[i];
    for (int i = 0; i < 1200; i++)
        to->str_2FECE.array_0x30311[i] = from->terrain_2FECE.entity_0x30311[i];
    to->str_2FECE.next_0x360D1 = from->terrain_2FECE.next_0x360D1;
    for (int i = 0; i < 8; i++)
        to->str_2FECE.next_0x360D2[i] = from->terrain_2FECE.next_0x360D2[i];
    for (int i = 0; i < 8; i++)
        to->str_2FECE.str_0x36442[i] = from->terrain_2FECE.stages_0x36442[i];
    for (int i = 0; i < 11; i++) {
        to->str_2FECE.array_0x3647A[i].str_0x3647A_byte_0 =
            from->terrain_2FECE.StageVars_0x3647A[i].index_0x3647A_0;
        to->str_2FECE.array_0x3647A[i].str_0x3647A_byte_1 =
            from->terrain_2FECE.StageVars_0x3647A[i].stage_0x3647A_1;
        to->str_2FECE.array_0x3647A[i].str_0x3647A_2 =
            from->terrain_2FECE.StageVars_0x3647A[i].str_0x3647A_2;
        to->str_2FECE.array_0x3647A[i].str_0x3647C_4.axis =
            from->terrain_2FECE.StageVars_0x3647A[i].str_0x3647C_4.axis;
    }
    to->str_0x364D2 = from->str_0x364D2;
    to->word_0x3653E = from->word_0x3653E;
    to->word_0x36540 = from->word_0x36540;
    ...
    for (int i = 0; i < 0x32; i++) {
        ...
        to->str_0x3664C[i].byte_3 = from->str_0x3664C[i].byte_3;
        to->str_0x3664C[i].axis3d_4 = from->str_0x3664C[i].axis3d_4;
        to->str_0x3664C[i].dword_A =
            ((uint8_t *) from->str_0x3664C[i].event_A.pointer_0x6E8E - Zero_pointer);
        for (int j = 0; j < 25; j++)
            to->str_0x3664C[i].array_E[j] = from->str_0x3664C[i].array_E[j];
    }
    to->byte_0x36DEA_fly_asistant = from->byte_0x36DEA_fly_asistant;
