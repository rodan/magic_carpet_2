...
class ViewPort:public Rectangle {
 public:
    ...
    uint16_t PreHeight_EA3C0 = 0;
     ...
     ViewPort(uint16_t viewPortPosX, uint16_t viewPortPosY, uint16_t viewPortWidth,
    ...
    void SetRenderViewPortSize_BCD45(uint16_t viewPortPosX, uint16_t viewPortPosY,
                                     uint16_t viewPortWidth, uint16_t viewPortHeight,
                                     uint16_t screenWidth, uint16_t screenHeight);
    void SetRenderViewPortSize_BCD45(uint8_t * ptrScreenBufferStart, uint16_t screenWidth,
                                     uint16_t viewPortWidth, uint16_t viewPortHeight);
    void SetRenderViewPortSize_40C50(uint8_t viewPortSizeSetting);
    Rectangle SetRenderViewPortSize_40C50(uint8_t viewPortSizeSetting, uint32_t screenWidth,
