...
int NetworkInitConnection_7308F(char *a2, __int16 a3)   //25408f
{
    ...
    while (maxPlayers_E127A > i && IndexInNetwork_E1276 == -1 && !connected_E12A6) {    //2541a1
    ...
    for (i = 0; i < maxPlayers_E127A; i++) {
        if (IndexInNetwork_E1276 != i) {
            strncpy(connection_E12AE[i]->ncb_name_26,
                    connection_E12AE[IndexInNetwork_E1276]->ncb_name_26,
                    sizeof(connection_E12AE[IndexInNetwork_E1276]->ncb_name_26));
                    ...
                    for (i = 0;; i++) {
                        ...
                        if (IndexInNetwork_E1276 != i && locConnected[i] == 1) {
                            ...
                            if (connection_E12AE[i]->ncb_cmd_cplt_49)
                                sprintf(printbuffer, "Error code (LISTEN) : %d",
                                        connection_E12AE[i]->ncb_cmd_cplt_49);
                        }
                    }
                } else {
                    while (1) {
                        ...
                        if (!connection_E12AE[IndexInNetwork2_E12A8]->ncb_cmd_cplt_49)
                            break;
                        sprintf(printbuffer, "Error code (CALL) : %d",
                                connection_E12AE[IndexInNetwork2_E12A8]->ncb_cmd_cplt_49);
                    }
                }
            }
        } else {
            ...
            if (IndexInNetwork_E1276 == a1) {
                ...
                if (IndexInNetwork2_E12A8 == IndexInNetwork_E1276) {
                    ...
                    while (1) {
                        ...
                        if (!connection_E12AE[IndexInNetwork2_E12A8]->ncb_cmd_cplt_49)
                            break;
                        snprintf(printbuffer, printBufferSize, "Error code (CALL) : %d",
                                 connection_E12AE[IndexInNetwork2_E12A8]->ncb_cmd_cplt_49);
                    }
                }
            }
...
void ReceiveSendAll_7438A(uint8_t *buffer, unsigned int size)   //25538a
{
    if (x_BYTE_E1274) {
        if (IndexInNetwork_E1276 == IndexInNetwork2_E12A8) {
            ...
            //fix some problems
            NetworkSendMessage2_74006(IndexInNetwork2_E12A8, (buffer + size * IndexInNetwork_E1276),
                                      size);
            timeState(true, "After Send, Before Receive");      //debug
            NetworkReceiveMessage2_7404E(IndexInNetwork2_E12A8, buffer,
                                         size * countConnected_E1278);
            //debug
            if (memcmp
                (&fixBuffer[IndexInNetwork_E1276 * size],
                 (char *)&buffer[IndexInNetwork_E1276 * size], size)) {
...
void WaitToConnect_7C230()      //25d230
{
    ...
    sub_7C120_draw_bitmap_640(x_DWORD_17DE38str.x_DWORD_17DEE4_mouse_positionx,
                              x_DWORD_17DE38str.x_DWORD_17DEE6_mouse_positiony,
                              xy_DWORD_17DED4_spritestr[timeCounter_E2094]);
    if (x_WORD_180660_VGA_type_resolution & 1)
...
bool SetMultiplayerColors_7CE50()       //25de50
{
    ...
    ReceiveSendAll_7438A((uint8_t *) x_DWORD_17DE38str.array_BYTE_17DE68x,
                         sizeof(type_BYTE_17DE68x));
    for (int v0 = 0; v0 < 8; v0++) {
        for (int j = 0; j < 8; j++) {
            x_DWORD_17DE38str.array_BYTE_17DE68x[v0].arrayColors_1[j] =
                x_DWORD_17DE38str.array_BYTE_17DE68x[GetIndexNetwork2_74515()].arrayColors_1[j];
    ...
    for (int i = 0; i < 8; i++) {
        if (x_DWORD_17DE38str.array_BYTE_17DE68x[i].connected_0) {
            ...
            case 2:
                ...
                {
                    if (i <= 0)
                        x_DWORD_17DE38str.array_BYTE_17DE68x[GetIndexNetwork2_74515()].
                            arrayColors_1[i] = i;
                    else
                        x_DWORD_17DE38str.array_BYTE_17DE68x[GetIndexNetwork2_74515()].
                            arrayColors_1[i] = i - 1;
            ...
            case 3:            //change to left character
                if (GetIndexNetwork2_74515() == GetIndexNetwork_74536()
                    && x_DWORD_17DE38str.x_WORD_17DEFE < 7) {
                    x_DWORD_17DE38str.array_BYTE_17DE68x[GetIndexNetwork2_74515()].
                        arrayColors_1[i] =
                        sub_7D230(1,
                                  x_DWORD_17DE38str.array_BYTE_17DE68x[GetIndexNetwork2_74515()].
    ...
    x_DWORD_17DE38str.x_WORD_17DEF4 =
        x_DWORD_17DE38str.array_BYTE_17DE68x[GetIndexNetwork2_74515()].
        arrayColors_1[x_DWORD_17DE38str.serverIndex_17DEFC];
    ...
    for (int v0 = 0; v0 < 8; v0++) {
        if (x_DWORD_17DE38str.array_BYTE_17DE68x[v0].connected_0) {
            if (v0 != x_DWORD_17DE38str.serverIndex_17DEFC) {
                SetPaletteColor_7CDC0(v0,
                                      x_DWORD_17DE38str.
                                      array_BYTE_17DE68x[GetIndexNetwork2_74515()].
                                      arrayColors_1[v0]);
            }
        }
    }
...
signed int sub_7D230(char a1, unsigned __int8 a2, unsigned __int8 a3)   //25e230
{
    ...
    if (a1) {
        do {
            ...
            v7 = 0;
            while (v5 < 8) {
                if (v5 != a3 && x_DWORD_17DE38str.array_BYTE_17DE68x[v5].connected_0
                    && x_DWORD_17DE38str.array_BYTE_17DE68x[GetIndexNetwork2_74515()].
                    arrayColors_1[v5] == (x_WORD) v3) {
                    v7 = 1;
                    break;
                }
                v5++;
        ...
        do {
            ...
            v8 = 0;
            while (v4 < 8) {
                if (v4 != a3 && x_DWORD_17DE38str.array_BYTE_17DE68x[v4].connected_0
                    && x_DWORD_17DE38str.array_BYTE_17DE68x[GetIndexNetwork2_74515()].
                    arrayColors_1[v4] == (x_WORD) v3) {
                    v8 = 1;
                    break;
                }
                v4++;
