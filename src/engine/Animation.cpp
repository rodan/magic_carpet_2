...
void PlayIntoSoundEvents_1B280(Type_SoundEvent_E17CC *pSoundEvent)      //1fc280
{
    while (1) {
        ...
        case 'p':
            ...
            break;
        case 'Q':
            sub_2EBB0_draw_text_with_border_630x340(x_DWORD_E9C4C_langindexbuffer
                                                    [pSoundEvent[x_WORD_D4004].index]);
            break;
        case 'R':
        case 'r':
            if (soundAble_E3798)
        ...
        case 's':
            if (soundAble_E3798) {
                if (pSoundEvent[x_WORD_D4004].index)
                    sub_8F100_sound_proc19(0, pSoundEvent[x_WORD_D4004].index, 127, 64, 0x64u, 0,
                                           2u);
                else
                    EndSample_8D8F0();
            }
...
void sub_75DB0()                //256db0
{
    ...
    DataFileIO::Read(x_DWORD_17DB38_intro_file_handle, x_DWORD_E9C38_smalltit,
                     x_DWORD_17D720[0] - 16);
...
void sub_75CB0()                //256cb0
{
    if (x_WORD_E12FE && sub_473E0()) {
        x_WORD_17DB5A = 1;
    } else if (x_WORD_17DB5C
               && (LastPressedKey_1806E4 || x_WORD_180746_mouse_left_button
                   || x_WORD_180744_mouse_right_button)) {
        x_WORD_17DB5A = 1;
    } else {
            ...
            if (LastPressedKey_1806E4 < 0x36u) {
                if (LastPressedKey_1806E4 != 0x2a)
                    goto LABEL_24;
                       ...
                       && (LastPressedKey_1806E4 < 0x3Bu || LastPressedKey_1806E4 > 0x3Fu
                           && LastPressedKey_1806E4 != 66)) {
                goto LABEL_24;
            }
