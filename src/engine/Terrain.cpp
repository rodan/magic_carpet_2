    ...
    if (debugafterload) {
        ...
        if (index >= skip2) {
            if (index >= stopstep) {
                ...
                if (!skip) {
                    comp20 =
                        compare_with_sequence(buffer1, (uint8_t *) mapTerrainType_10B4E0, 0x2dc4e0,
                                              index - skip2, 0x70000, 0x10000, &origbyte20,
                                              &remakebyte20, 0, (exitindex != 1000000));
                    comp20 =
                        compare_with_sequence(buffer1, (uint8_t *) mapHeightmap_11B4E0, 0x2dc4e0,
                                              index - skip2, 0x70000, 0x10000, &origbyte20,
                                              &remakebyte20, 0x10000, (exitindex != 1000000));
                    comp20 =
                        compare_with_sequence(buffer1, (uint8_t *) mapShading_12B4E0, 0x2dc4e0,
                                              index - skip2, 0x70000, 0x10000, &origbyte20,
                                              &remakebyte20, 0x20000, (exitindex != 1000000));
                    comp20 =
                        compare_with_sequence(buffer1, (uint8_t *) mapAngle_13B4E0, 0x2dc4e0,
                                              index - skip2, 0x70000, 0x10000, &origbyte20,
                                              &remakebyte20, 0x30000, (exitindex != 1000000));
                    comp20 =
                        compare_with_sequence(buffer1, (uint8_t *) mapEntityIndex_15B4E0, 0x2dc4e0,
                                              index - skip2, 0x70000, 0x20000, &origbyte20,
                                              &remakebyte20, 0x50000, (exitindex != 1000000));

#ifdef TEST_x64
                    type_shadow_D41A0_BYTESTR_0 shadow_D41A0_BYTESTR_0;
                    Convert_to_shadow_D41A0_BYTESTR_0(&D41A0_0, &shadow_D41A0_BYTESTR_0);
                    comp20 =
                        compare_with_sequence_D41A0(buffer2, (uint8_t *) & shadow_D41A0_BYTESTR_0,
                                                    0x356038, index - skip2, 224790, &origbyte20,
                                                    &remakebyte20, 0, (exitindex != 1000000));
#else
                    comp20 =
                        compare_with_sequence_D41A0(buffer2, (uint8_t *) & D41A0_0, 0x356038, index,
                                                    224790, &origbyte20, &remakebyte20, 0,
                                                    (exitindex != 1000000));
#endif
...
void GenerateLevelMap_43830(type_str_2FECE *a2x)        //224830
{
    ...
    sub_B5E70_decompress_terrain_map_level(x_WORD_17B4E0, a2x->offset_0x2FEE9, a2x->raise_0x2FEED,
                                           a2x->gnarl_0x2FEF1);
...
int sub_B5C60_getTerrainAlt2(uint16_t axisX, uint16_t axisY)    //296c60
{
    ...
    if ((locV2._axis_2d.x + locV2._axis_2d.y) & 1) {
        if (locY._axis_2d.x > (locY._axis_2d.x + locX._axis_2d.x) % 256) {
            ...
            locV2._axis_2d.y--;
            diaPoint =
                (255 - locY._axis_2d.x) * (mapHeightmap_11B4E0[locV2.word] - point2) +
                locX._axis_2d.x * (point2 - point1);
        } else {
            point1 = mapHeightmap_11B4E0[locV2.word];
            locV2._axis_2d.x++;
        ...
        if (locX._axis_2d.x <= locY._axis_2d.x) {
            ...
            locV2._axis_2d.x++;
            diaPoint =
                locY._axis_2d.x * (point2 - point1) +
                locX._axis_2d.x * (mapHeightmap_11B4E0[locV2.word] - point2);
        } else {
            point1 = mapHeightmap_11B4E0[locV2.word];
            locV2._axis_2d.x++;
            point2 = mapHeightmap_11B4E0[locV2.word];
            locV2._axis_2d.y++;
            diaPoint =
                locY._axis_2d.x * (mapHeightmap_11B4E0[locV2.word] - point2) +
                locX._axis_2d.x * (point2 - point1);
        }
        result = (diaPoint >> 3) + 32 * point1;
    }
...
void sub_44580()                //225580
{
            ...
            if (unk_D47E0[4 * i + 1] >= 0) {
                if (unk_D47E0[4 * i + 2] >= 0) {
                    if (unk_D47E0[4 * i + 3] >= 0) {
                        actBufPos =
                            &pdwScreenBuffer_351628[25 *
                                                    (49 * unk_D47E0[4 * i + 1] +
                                                     7 * unk_D47E0[4 * i + 2] + unk_D47E0[4 * i +
                                                                                          3] +
                                                     343 * unk_D47E0[4 * i + 0])];
                        if (*actBufPos < 12) {
                        ...
                        actBufPos =
                            &pdwScreenBuffer_351628[25 *
                                                    (49 * unk_D47E0[4 * i + 0] +
                                                     unk_D47E0[4 * i + 2] + 7 * unk_D47E0[4 * i +
                                                                                          3] +
                                                     343 * unk_D47E0[4 * i + 1])];
                        if (*actBufPos < 12) {
                        ...
                        actBufPos =
                            &pdwScreenBuffer_351628[25 *
                                                    (49 * unk_D47E0[4 * i + 3] +
                                                     unk_D47E0[4 * i + 1] + 7 * unk_D47E0[4 * i +
                                                                                          0] +
                                                     343 * unk_D47E0[4 * i + 2])];
                        if (*actBufPos < 12) {
                        ...
                        actBufPos =
                            &pdwScreenBuffer_351628[25 *
                                                    (49 * unk_D47E0[4 * i + 2] +
                                                     unk_D47E0[4 * i + 0] + 7 * unk_D47E0[4 * i +
                                                                                          1] +
                                                     343 * unk_D47E0[4 * i + 3])];
                        if (*actBufPos < 12) {
                        ...
                        actBufPos =
                            &pdwScreenBuffer_351628[25 *
                                                    (49 * unk_D47E0[4 * i + 2] +
                                                     8 * unk_D47E0[4 * i + 3] - unk_D47E0[4 * i +
                                                                                          3] +
                                                     unk_D47E0[4 * i + 0] + 343 * unk_D47E0[4 * i +
                                                                                            1])];
                        if (*actBufPos < 12) {
                        ...
                        actBufPos =
                            &pdwScreenBuffer_351628[25 *
                                                    (49 * unk_D47E0[4 * i + 1] +
                                                     8 * unk_D47E0[4 * i + 0] - unk_D47E0[4 * i +
                                                                                          0] +
                                                     unk_D47E0[4 * i + 3] + 343 * unk_D47E0[4 * i +
                                                                                            2])];
                        if (*actBufPos < 12) {
                        ...
                        actBufPos =
                            &pdwScreenBuffer_351628[25 *
                                                    (49 * unk_D47E0[4 * i + 0] +
                                                     7 * unk_D47E0[4 * i + 1] + unk_D47E0[4 * i +
                                                                                          2] +
                                                     343 * unk_D47E0[4 * i + 3])];
                        if (*actBufPos < 12) {
    ...
    for (int i = 0; i < 256 * 256; i++) {
        ...
        if (!mapTerrainType_10B4E0[uindex.word]) {
            ...
            uindex._axis_2d.y--;
            actBufEnt =
                pdwScreenBuffer_351628[25 * (343 * point1 + 49 * point2 + point4 + 7 * point3)];
            if (actBufEnt) {
                x_WORD_17B4E0 = 9377 * x_WORD_17B4E0 + 9439;
                if (x_WORD_17B4E0 % (actBufEnt + 1) >= actBufEnt)
                    actBufPos =
                        &pdwScreenBuffer_351628[25 *
                                                (343 * point1 + 49 * point2 + point4 + 7 * point3)];
                else
                    actBufPos =
                        &pdwScreenBuffer_351628[x_WORD_17B4E0 % (actBufEnt + 1) +
                                                25 * (343 * point1 + 49 * point2 + point4 +
                                                      7 * point3)];
...
void sub_44D00()                //225d00
{
    ...
    for (int i = 0; i < 256 * 256; i++) {
        ...
        index._axis_2d.x -= 2;
        index._axis_2d.y -= 2;
        tempIndex._axis_2d.x =
            mapHeightmap_11B4E0[index.word] - mapHeightmap_11B4E0[tempIndex.word] + 32;
        index._axis_2d.x++;
        index._axis_2d.y++;
...
void sub_44EE0_smooth_tiles(uaxis_2d axis)      //225ee0
{
    ...
    do {
        ...
        if (mapTerrainType_10B4E0[tempAxis1.word]
            && minHeight > mapHeightmap_11B4E0[tempAxis1.word]) {
            minHeight = mapHeightmap_11B4E0[tempAxis1.word];
            tempAxis2.word = tempAxis1.word;
        }
...
void sub_45DC0(uint8_t inType, uaxis_2d axis2d, uint8_t type2)  //226dc0
{
    ...
    if (type2 >= 8u) {
        ...
        case 0xAu:
            ...
            mapAngle_13B4E0[axis2d.word] =
                mapAngle_13B4E0[axis2d.word] & 0x8F | unk_D4A30[0x80 + 2 * heightType + 1];
            break;
        case 0xBu:
        ...
        case 0xFu:
            ...
            break;
        case 0x10u:
            if (mapTerrainType_10B4E0[axis2d.word] == 10 || mapTerrainType_10B4E0[axis2d.word] == 11
                || mapTerrainType_10B4E0[axis2d.word] == 12)
                break;
            heightType = sub_45BE0(inType, axis2d);
            mapTerrainType_10B4E0[axis2d.word] = unk_D4A30[2 * heightType];
            mapAngle_13B4E0[axis2d.word] =
                mapAngle_13B4E0[axis2d.word] & 0x8F | unk_D4A30[2 * heightType + 1];
            break;
        case 0x11u:
            heightType = sub_45BE0(inType, axis2d);
            mapTerrainType_10B4E0[axis2d.word] = unk_D4A30[0x40 + 2 * heightType];
            mapAngle_13B4E0[axis2d.word] =
                mapAngle_13B4E0[axis2d.word] & 0x8F | unk_D4A30[0x40 + 2 * heightType + 1];
            break;
        case 0x12u:
            heightType =
                (8 * ((axis2d._axis_2d.y + axis2d._axis_2d.x) & 1) + sub_45BE0(inType, axis2d));
            mapTerrainType_10B4E0[axis2d.word] = unk_D4A30[0x50 + 2 * heightType];
            mapAngle_13B4E0[axis2d.word] =
                mapAngle_13B4E0[axis2d.word] & 0x8F | unk_D4A30[0x50 + 2 * heightType + 1];
            break;
        case 0x13u:
            heightType =
                (8 * ((axis2d._axis_2d.y + axis2d._axis_2d.x) & 1) + sub_45BE0(inType, axis2d));
            ...
            mapAngle_13B4E0[axis2d.word] =
                mapAngle_13B4E0[axis2d.word] & 0x8F | unk_D4A30[0x60 + 2 * heightType + 1];
            break;
        case 0x14u:
            heightType = sub_45BE0(inType, axis2d);
            mapTerrainType_10B4E0[axis2d.word] = unk_D4A30[0x10 + 2 * heightType];
            mapAngle_13B4E0[axis2d.word] =
                mapAngle_13B4E0[axis2d.word] & 0x8F | unk_D4A30[0x10 + 2 * heightType + 1];
            break;
        case 0x15u:
            heightType = sub_45BE0(inType, axis2d);
            mapTerrainType_10B4E0[axis2d.word] = unk_D4A30[0x20 + 2 * heightType];
            mapAngle_13B4E0[axis2d.word] =
                mapAngle_13B4E0[axis2d.word] & 0x8F | unk_D4A30[0x20 + 2 * heightType + 1];
            break;
        case 0x16u:
            heightType = sub_45BE0(inType, axis2d);
            mapTerrainType_10B4E0[axis2d.word] = unk_D4A30[0x30 + 2 * heightType];
            mapAngle_13B4E0[axis2d.word] =
                mapAngle_13B4E0[axis2d.word] & 0x8F | unk_D4A30[0x30 + 2 * heightType + 1];
            break;
        default:
            break;
        }
    ...
    for (int indexY = yAdd; indexY; indexY--) {
        for (int indexX = xAdd; indexX; indexX--) {
            if (mapTerrainType_10B4E0[tempAxis.word] == 1) {
                ...
                tempAxis._axis_2d.y--;
                terModIndex =
                    (point4 & 7) + 7 * (point3 & 7) + 49 * (point2 & 7) + 343 * (point1 & 7);
                mapTerrainType_10B4E0[tempAxis.word] = x_BYTE_F2CD0x[terModIndex][0];
                if (x_BYTE_F2CD0x[terModIndex][0] >= 8u) {
                    nextAngle =
                        x_BYTE_F2CD0x[terModIndex][1] + (mapAngle_13B4E0[tempAxis.word] & 0x87);
                } else {
                    x_WORD_17B4E0 = 9377 * x_WORD_17B4E0 + 9439;
    ...
    if (yAdd != 0) {
        for (int indexY = yAdd; indexY; indexY--) {
            for (int indexX = xAdd; indexX; indexX--) {
                ...
                if (isCaveLevel_D41B6
                    && (x_BYTE_14B4E0_second_heightmap[tempAxis.word] <=
                        mapHeightmap_11B4E0[tempAxis.word])) {
                    x_BYTE_14B4E0_second_heightmap[tempAxis.word] =
                        mapHeightmap_11B4E0[tempAxis.word] - 1;
...
int sub_B5D68(uint16_t inX, uint16_t inY)       //296d68
{
    ...
    if ((tempInX._axis_2d.y + tempInY._axis_2d.y) & 1) {
        if (tempInY._axis_2d.x > (tempInY._axis_2d.x + tempInX._axis_2d.x) % 256) {
            ...
            tempAxis._axis_2d.y--;
            finalComp =
                tempInY._axis_2d.x * (x_BYTE_14B4E0_second_heightmap[tempAxis.word] - point2) +
                tempInX._axis_2d.x * (point2 - point1);
        } else {
            point1 = x_BYTE_14B4E0_second_heightmap[tempAxis.word];
            tempAxis._axis_2d.x++;
            point2 = x_BYTE_14B4E0_second_heightmap[tempAxis.word];
            ...
            tempAxis._axis_2d.y++;
            finalComp =
                tempInY._axis_2d.x * (x_BYTE_14B4E0_second_heightmap[tempAxis.word] - point1) +
                tempInX._axis_2d.x * (point2 - point1);
        }
        ...
        if (tempInX._axis_2d.x <= tempInY._axis_2d.x) {
            ...
            tempAxis._axis_2d.x++;
            finalComp =
                tempInY._axis_2d.x * (point2 - point1) +
                tempInX._axis_2d.x * (x_BYTE_14B4E0_second_heightmap[tempAxis.word] - point2);
        } else {
            point1 = x_BYTE_14B4E0_second_heightmap[tempAxis.word];
            tempAxis._axis_2d.x++;
            point2 = x_BYTE_14B4E0_second_heightmap[tempAxis.word];
