...
extern event_t *x_DWORD_EA3E4[1001];  //2bb3e4
...
unsigned int sub_6FC80_pre_draw_text(char *a1, __int16 a2, __int16 a3, __int16 a4,
                                     unsigned __int8 a5);
void sub_75D70(uint8_t * a1, uint32_t a2);
void DrawLine_2BC80(int16_t posStartX, int16_t posStartY, int16_t posEndX, int16_t posEndY,
                    uint8_t colorIdx);
...
void DrawLineLowRes_90164(int16_t posStartX, int16_t posStartY, int16_t posEndX, int16_t posEndY,
                          uint8_t colorIdx);
void DrawLineHighRes_901E4(int16_t posStartX, int16_t posStartY, int16_t posEndX, int16_t posEndY,
                           uint8_t colorIdx);
void sub_6F940_sub_draw_text(const char *textbuffer, int posx, int posy, uint8_t color);        //250940
void sub_72C40_draw_bitmap_640_setcolor(__int16 a1, __int16 a2, posistruct_t a3,
                                        unsigned __int8 a4);
void sub_8C635_draw_cursor();
void sub_8F935_bitmap_draw_final(uint8_t a1byte1, uint8_t a1byte2, uint16_t a2, int a3,
                                 uint8_t * a4, uint8_t setbyte, char a6);
void sub_8F920(uint8_t a1byte1, uint8_t a1byte2, int16_t posx, int16_t posy, uint8_t * a4,
               unsigned __int8 a5, char a6);

void sub_99A77_create_index_dattab_div(uint8_t * a1, uint8_t * a2, uint8_t * a3, posistruct_t * a4);
void sub_99AEB_create_index_dattab_minus(uint8_t * a1, uint8_t * a2, uint8_t * a3,
                                         posistruct_t * a4);
void sub_98709_create_index_dattab_power(posistruct2_t * a1, posistruct2_t * a2, uint8_t * a3,
                                         posistruct_t * a4);
void sub_98709_create_index_dattab_power_add(uint8_t * a1, uint8_t * a2, uint8_t * a3,
                                             posistruct_t * a4, int add);
void sub_9874D_create_index_dattab(posistruct2_t * a1, posistruct2_t * a2, uint8_t * a3,
                                   posistruct_t * a4);
void sub_9874D_create_index_dattab_add(uint8_t * a1, uint8_t * a2, uint8_t * a3, posistruct_t * a4,
                                       int add);
...
void Convert_to_shadow_D41A0_BYTESTR_0(type_D41A0_BYTESTR_0 * from,
                                       type_shadow_D41A0_BYTESTR_0 * to);
