...
/* ---- */ void GameRenderOriginal::DrawWorld_411A0(int posX, int posY, int16_t yaw, int16_t posZ,
...
void GameRenderOriginal::DrawTerrainAndParticles_3C080(__int16 posX, __int16 posY, __int16 yaw,
                                                       signed int posZ, int pitch, int16_t roll,
                                                       int fov)
{
    int v9;                     // eax
    int v10;                    // edx
...
void GameRenderOriginal::sub_88740(event_t *a1x, int a2, int a3)
{
    int v3;                     // esi
    event_t *v4x;     // edx
...
void GameRenderOriginal::DrawSorcererNameAndHealthBar_2CB30(event_t *a1x, __int16 a2, int a3, __int16 a4)     //20db30 //maybe draw sorcerer name
{
    char *v5;                   // esi
    int v9x;                    // eax
    int v9y;                    // eax
