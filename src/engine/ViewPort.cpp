...
ViewPort::ViewPort(uint16_t viewPortPosX, uint16_t viewPortPosY, uint16_t viewPortWidth,
...
ViewPort::ViewPort(uint16_t viewPortPosX, uint16_t viewPortPosY, uint16_t viewPortWidth,
                   uint16_t viewPortHeight, uint16_t viewPortPreWidth, uint16_t viewPortPreHeight)
{
    PosX_EA3D0 = viewPortPosX;
    PosY_EA3CC = viewPortPosY;
    Width_DE564 = viewPortWidth;
...
void ViewPort::SetRenderViewPortSize_40BF0(int width, int height, int viewPortWidth, int viewPortHeight)        //221bf0
{
    ...
    str_F2C20ar.dword0x0e_ptrScreenRenderBufferStart =
        width_help + screenWidth_18062C * height_help;
    SetRenderViewPortSize_BCD45(str_F2C20ar.dword0x0e_ptrScreenRenderBufferStart +
                                pdwScreenBuffer_351628, screenWidth_18062C, viewPortWidth_help,
                                viewPortHeight_help);
}
...
{
    Rectangle rectangle =
        SetRenderViewPortSize_40C50(viewPortSizeSetting, screenWidth_18062C, screenHeight_180624);
    ...
    SetRenderViewPortSize_BCD45(pdwScreenBuffer_351628 + ptr, screenWidth_18062C,
                                rectangle.Width_DE564, rectangle.Height_DE568);
}
...
void ViewPort::SetRenderViewPortSize_BCD45(uint16_t viewPortPosX, uint16_t viewPortPosY,
                                           ...
                                           uint16_t screenWidth, uint16_t screenHeight)
{
    ...
    SetRenderViewPortSize_BCD45(ptrScreenRenderBufferStart + pdwScreenBuffer_351628,
                                iScreenWidth_DE560, Width_DE564, Height_DE568);
}

void ViewPort::SetRenderViewPortSize_BCD45(uint8_t *ptrScreenBufferStart, uint16_t screenWidth,
                                           uint16_t viewPortWidth, uint16_t viewPortHeight)
{
    if (screenWidth) {
        iScreenWidth_DE560 = screenWidth;
