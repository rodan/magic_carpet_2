...
void qmemcpy(int **a, char *b, unsigned int c)
{                               //tom stub
}
...
BOOL sub_86A00()
{
    ...
    if (v0) {
        if (sub_86010()) {
            ...
            v5 = 0;
            for (i = (unsigned __int8)byte_180471; i <= (signed int)(unsigned __int8)byte_180472;
                 ++i) {
...
char sub_83E00(int a1, int a2)
{
    ...
    if (a2 == *(DWORD *) (a1 + 4)) {
        *(BYTE *) (a1 + 16) = byte_E29E8;
        ...
        for (i = (int *)&dword_17ECA0; i < (int *)&dword_17FEA0 && i[1];
             i = (int *)((char *)i + 18)) ;
...
void sub_85070()                //266070
{
    ...
    if (!dword_17E0A8[0])       //dword_17E0A8 //266079
    {
        ...
        qsort((void *)dword_17E0A0, v5, 12,
              (int (__cdecl *) (const void *, const void *))sub_85060);
        do {
            v17 = 9 * v16++;
...
DWORD *sub_A5850(int a1, char a2, unsigned int a3, signed int a4, int a5)
{
    ...
    if (a3 < 0x6F) {
        ...
        if (a3 <= 0x6C) {
            if (*(DWORD *) (a1 + 28))
                *(DWORD *) (a1 + 4 * v8 + 724) =
                    (*(int (__cdecl **) (int, int, signed int))(a1 + 28)) (a1, v8, a4);
            goto LABEL_79;
        }
        if (a3 <= 0x6D) {
 ...
 LABEL_79:
            if (v7[v9 + 8] != 1 || (result = (DWORD *) v7[v9 + 24], result == (DWORD *) a1)) {
                ...
                if (v13 != 144 || (result = (DWORD *) (a1 + 4 * v8), result[133] < 64)) {
                    if (!v7[104]
                        || (result =
                            (DWORD
                             *) ((int (__cdecl *) (DWORD *, int, int, unsigned int, signed int))
                                 v7[104]) (v7, a1, v9 | v13, a3, a4)) == 0) {
        ...
        *(DWORD *) (a1 + 108) -= *(DWORD *) (a1 + 104);
        ...
        if (*(DWORD *) (a1 + 36))
            result =
                (DWORD *) (*(int (__cdecl **) (DWORD *, int, DWORD, DWORD))(a1 + 36)) (v7, a1, 0,
                                                                                       0);
    } else {
        if (a3 != 119)
            goto LABEL_79;
...
DWORD *sub_A8EA0(DWORD *a1, int a2)
{
    ...
    if (result[8] == 1) {
        ...
        while (v6) {
            if (*(DWORD *) (v3 + 4) != 1) {
                for (i = 0; i < 32; ++i) {
                    if (*(DWORD *) (v3 + 4 * i + 1368) != -1
                        && *(DWORD *) (v3 + 4 * *(DWORD *) (v3 + 4 * i + 1368) + 148) == v4) {
                        sub_A5850(v3, *(unsigned int *)(v3 + 4 * i + 1368) | 0x80,
                                  *(DWORD *) (v3 + 4 * i + 1496), 0, 0);
                        *(DWORD *) (v3 + 4 * i + 1368) = -1;
                    }
                }
            }
...
int sub_A8BF0(DWORD *a1)
{
    ...
    if (v5 == -1) {
        ...
        while (v9) {
            if (*(DWORD *) (v3 + 4) != 1) {
                for (k = 0; k < 32; ++k) {
                    if (*(DWORD *) (v3 + 4 * k + 1368) != -1
                        && *(DWORD *) (v3 + 4 * *(DWORD *) (v3 + 4 * k + 1368) + 148) == v5) {
                        sub_A5850(v3, *(unsigned int *)(v3 + 4 * k + 1368) | 0x80,
                                  *(DWORD *) (v3 + 4 * k + 1496), 0, 0);
                        *(DWORD *) (v3 + 4 * k + 1368) = -1;
                    }
                }
            }
...
int off_E3E34(unsigned int mem)
{                               //tom stub free memory
    return 0;
};
