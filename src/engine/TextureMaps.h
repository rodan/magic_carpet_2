...
subtype_x_DWORD_E9C28_str *LoadTMapMetadata_71E70(type_x_DWORD_E9C28_str * a1y, unsigned int a2,
                                                  __int16 a3);
...
void WriteTextureMapToBmp(uint16_t texture_index, type_particle_str * ptextureMap,
                          MapType_t mapType);
